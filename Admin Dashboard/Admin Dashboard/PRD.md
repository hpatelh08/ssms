...
- Class 1-7 via Student ID + access key
- Class 8-10 via Parent ID + password
...
| Parent Management | Parent account lifecycle | Parent login, create/link children (class 8-10), password reset | `backend/routes/parents.js`, `frontend-react/public/js/admin.js`, `frontend/login.html` |
...
| Parent Access-Key Login | Class 1-7 parent login using student ID + access key | Legacy `frontend/login.html` | `backend/routes/students.js`, `frontend/js/auth.js` |
| Parent ID Login | Class 8-10 parent login with credentials | Legacy `frontend/login.html` | `backend/routes/parents.js`, `frontend/js/auth.js` |
...
- FR-18: System shall link parent accounts to students in classes 8-10 via mapping table.
...
1. Admin creates parent with child links (class 8-10 only).
...
| POST | `/api/students/access-key-login` | Parent login for class 1-7 |
...
- Class 1-7: access-key login
- Class 8-10: parent ID/password accounts
