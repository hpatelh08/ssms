...
function buildSidebar() {
  ...
  <nav class="sidebar-nav">
    ...
    <a href="visitor-inquiries.html" class="nav-item" data-page="visitorInquiries" data-roles="super_admin,admin">
      <span class="nav-icon">✉️</span>
      <span class="nav-text">Visitor Inquiries</span>
      <span class="nav-badge hidden" id="visitorInquiryNavBadge">0</span>
    </a>
  </nav>
