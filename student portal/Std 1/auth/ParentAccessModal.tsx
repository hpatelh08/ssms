...
const themedSurface = {
  ...
  modalPanel: {
    background: 'linear-gradient(145deg, #fff7eb 0%, #fff0f6 46%, #eefdf8 100%)',
  ...
  modalGlow: {
    background: 'linear-gradient(145deg, rgba(116,211,255,0.14), transparent 42%), radial-gradient(circle at top right, rgba(255,122,89,0.16), transparent 42%), radial-gradient(circle at bottom left, rgba(255,216,107,0.16), transparent 36%)',
  } as React.CSSProperties,
  badge: {
          ...
          >
            ...
            <div className="relative px-7 pt-6 pb-8 md:px-8 md:pt-7 md:pb-9">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <div className="inline-flex items-center gap-2 rounded-full px-3 py-1.5 text-[11px] font-extrabold" style={themedSurface.badge}>Cartoon Parent Pass</div>
