 ...
 *
 * Student: Student  |  Level 4  |  XP 1480
...
/** Subject curriculum data (Std 1 NCERT). */
...
export const BASELINE_ALERTS: MockAlert[] = [
  {
    ...
    description:
      'Hindi reading comprehension improved by 14% this week. The student is completing Hindi passages faster and with better accuracy.',
