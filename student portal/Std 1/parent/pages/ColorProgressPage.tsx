...
export const ColorProgressPage: React.FC = () => {
  ...
  const summaryMetrics = [
    ...
    { icon: '🖍️', label: 'Colors Learned', value: cs.colorsLearned, color: CLR.purple, gradient: 'linear-gradient(135deg, #F3E8FF 0%, #EDE9FE 100%)' },
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', paddingBottom: 40, position: 'relative' }}>
      ...
      <FloatingParticle delay={1.2} size={60} color="#8B5CF6" left="90%" top="5%" />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginBottom: 24 }}>
        ...
        <GamificationCard icon="🎮" label="Activities Done" value={gam.completedActivities}
          ...
          gradient="linear-gradient(135deg, #EDE9FE 0%, #E0E7FF 100%)" delay={0.46} />
