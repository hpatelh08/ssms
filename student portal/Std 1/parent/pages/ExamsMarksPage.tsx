...
const THEMES: Record<string, Theme> = {
  ...
  2: {
    hero: 'linear-gradient(135deg, rgba(34,197,94,0.96), rgba(16,185,129,0.96), rgba(20,184,166,0.94))',
    panel: 'rgba(255,255,255,0.16)',
    label: 'text-white/75',
    accent: '#ecfeff',
    chip: 'rgba(255,255,255,0.16)',
    border: 'rgba(255,255,255,0.18)',
    shadow: '0 24px 50px rgba(16,185,129,0.22)',
  },
  3: {
    hero: 'linear-gradient(135deg, rgba(15,23,42,0.96), rgba(30,41,59,0.96), rgba(88,28,135,0.94))',
    panel: 'rgba(255,255,255,0.14)',
    label: 'text-white/80',
    accent: '#f8fafc',
    chip: 'rgba(255,255,255,0.14)',
    border: 'rgba(255,255,255,0.16)',
    shadow: '0 24px 50px rgba(88,28,135,0.24)',
  },
  4: {
  ...
  5: {
    hero: 'linear-gradient(135deg, rgba(22,163,74,0.96), rgba(34,197,94,0.96), rgba(132,204,22,0.94))',
    panel: 'rgba(255,255,255,0.16)',
    label: 'text-white/75',
    accent: '#f0fdf4',
    chip: 'rgba(255,255,255,0.16)',
    border: 'rgba(255,255,255,0.18)',
    shadow: '0 24px 50px rgba(34,197,94,0.22)',
  },
  6: {
    hero: 'linear-gradient(135deg, rgba(14,165,233,0.96), rgba(6,182,212,0.96), rgba(59,130,246,0.94))',
    panel: 'rgba(255,255,255,0.16)',
    label: 'text-white/75',
    accent: '#f0f9ff',
    chip: 'rgba(255,255,255,0.16)',
    border: 'rgba(255,255,255,0.18)',
    shadow: '0 24px 50px rgba(14,165,233,0.22)',
  },
  default: {
    hero: 'linear-gradient(135deg, rgba(59,130,246,0.96), rgba(99,102,241,0.96), rgba(168,85,247,0.94))',
    panel: 'rgba(255,255,255,0.16)',
