                ...
                <div className="mt-6 grid gap-4 md:grid-cols-[160px_1fr]">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {[
                      ...
                      <div key={label} className="rounded-2xl px-4 py-3" style={{ background: 'rgba(255,255,255,0.82)', border: '1px solid rgba(148,163,184,0.16)' }}>
                        <div className="text-[11px] font-extrabold uppercase tracking-[0.18em]" style={{ color: '#64748b' }}>{label}</div>
                        <div className="mt-1 text-[14px] font-bold break-words" style={{ color: 'var(--text-primary)' }}>{value || '-'}</div>
                      </div>
                    ))}
                  </div>
                </div>
