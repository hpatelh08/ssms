...
const T = {
  ...
  greetingBg: 'rgba(255,255,255,0.18)',
  greetingText: '#ffffff',
} as const;
...
const DOTS = [
  { top: '14%', left: '5%', size: 6, color: '#fbbf24', dur: 5.5, delay: 0 },
  { top: '70%', right: '6%', size: 5, color: '#34d399', dur: 6, delay: 1.8 },
  { bottom: '20%', left: '54%', size: 4.5, color: '#f472b6', dur: 5, delay: 3 },
];
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: `
          ...
          radial-gradient(circle at 18% 24%, rgba(255,255,255,0.20), transparent 36%),
          radial-gradient(circle at 52% 108%, rgba(255, 184, 107, 0.32), transparent 46%),
          linear-gradient(135deg, #ff8a5b 0%, #ffb347 34%, #ffe27a 64%, #9be7c4 100%)
        `,
        boxShadow: '0 25px 70px rgba(255, 164, 95, 0.26), 0 8px 24px rgba(255, 193, 117, 0.18)',
    ...
    >
      ...
      <FloatingBlob size={280} top="-38%" right="-14%"
        color="rgba(255,255,255,0.10)" xRange={16} yRange={12} dur={10}
      />
      <FloatingBlob size={220} bottom="-32%" left="-10%"
        color="rgba(255,255,255,0.08)" xRange={14} yRange={16} dur={8}
      />
        ...
        <div className="flex flex-col gap-3 min-w-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              style={{
                width: 84, height: 84,
                background: 'linear-gradient(135deg, rgba(255,255,255,0.30), rgba(255,244,214,0.18))',
                boxShadow:
                  '0 0 0 6px rgba(255,255,255,0.22), 0 10px 25px rgba(255, 170, 90, 0.24)',
                willChange: 'transform',
              }}
              animate={
                avatarBounce
            ...
            <div className="min-w-0 flex-1">
              ...
              >
                <span style={{
                  ...
                  background: 'rgba(255,255,255,0.28)', color: '#fffef8',
              ...
              <h1 style={{
                ...
                lineHeight: 1.2, margin: '8px 0 0', color: '#fffef8',
