...
export const ParentTopBar: React.FC = React.memo(() => {
  const { user } = useAuth();
  ...
  return (
    <motion.header
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(238,242,255,0.92) 0%, rgba(245,240,255,0.90) 40%, rgba(252,235,243,0.86) 100%)',
        backdropFilter: 'blur(36px)',
        WebkitBackdropFilter: 'blur(36px)',
        borderBottom: '1px solid rgba(255,255,255,0.6)',
        boxShadow: '0 2px 32px rgba(92,106,196,0.06), 0 1px 2px rgba(92,106,196,0.03)',
      }}
      initial={{ y: -64 }}
      animate={{ y: 0 }}
      transition={springIn}
    >
      <div className="h-full flex items-center justify-between px-4 lg:px-6 lg:pl-[276px] relative">
        ...
        <div className="flex items-center gap-3 min-w-0 shrink-0">
          ...
          <div style={{
            ...
            color: '#6B5CF6', background: '#EDE9FE',
            padding: '6px 14px', borderRadius: 14,
            border: '1px solid rgba(107,92,246,0.15)',
          }}>
            <span style={{ fontWeight: 700 }}>Guardian Console</span>
            <span style={{ fontSize: 9, fontWeight: 500, color: '#8B7CF6', marginTop: 1 }}>Std 1 Analytics View</span>
          </div>
