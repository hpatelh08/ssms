 ...
 * ================================
 * Parses "English Class 1.pdf" and "Mathematics Class 1.pdf"
...
// ─── Configuration ────────────────────────────────────────
const PDF_FILES = [
  { file: 'English Class 1.pdf', subject: 'English', skipPages: 12 },
  { file: 'Mathematics Class 1.pdf', subject: 'Math', skipPages: 12 },
];
 ...
 *   - English Class 1.pdf  (${allChunks.filter(c => c.subject === 'English').length} chunks)
 *   - Mathematics Class 1.pdf  (${allChunks.filter(c => c.subject === 'Math').length} chunks)
 */
