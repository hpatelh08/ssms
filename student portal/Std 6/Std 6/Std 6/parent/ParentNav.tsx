...
export type ParentScreen = 'overview' | 'progress' | 'attendance' | 'ai-buddy' | 'books' | 'garden' | 'fillblanks' | 'settings';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'garden',      label: 'Brain Puzzle',  sublabel: 'Puzzles', icon: '🧩', gradient: 'from-purple-400 to-indigo-500', glowColor: 'rgba(139,92,246,0.20)',    accentColor: '#8b5cf6', iconBg: 'rgba(139,92,246,0.10)' },
  { key: 'fillblanks',  label: 'Fill in the Blanks', sublabel: 'Student Panel', icon: '✍️', gradient: 'from-amber-400 to-orange-500',  glowColor: 'rgba(245,158,11,0.20)',    accentColor: '#f59e0b', iconBg: 'rgba(245,158,11,0.10)' },
