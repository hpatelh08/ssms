...
export const GameSessionScreen: React.FC<Props> = ({
  ...
  // ── Current question ──
  const globalIndex = (currentMiniLevel - 1) * QUESTIONS_PER_LEVEL + currentQIndex;
  ...
  const handleContinue = useCallback(() => {
    ...
    if (currentMiniLevel >= totalLevels) {
  ...
  }, [phase, currentMiniLevel, wrongPool, xpEarned, onGameWin, onExit, sessionKey, subject, chapter.id, gameType.id, difficulty, totalLevels]);
  ...
  return (
    <div className="min-h-[60vh] pb-8">
      ...
      <CelebrationModal
        ...
        difficulty={difficulty}
        isDifficultyComplete={currentMiniLevel >= totalLevels}
        newBadge={newBadge}
