...
const WATER_READER_BG = `
  radial-gradient(circle at 16% 12%, rgba(125,211,252,0.35) 0%, transparent 28%),
  radial-gradient(circle at 82% 10%, rgba(186,230,253,0.45) 0%, transparent 24%),
  radial-gradient(circle at 50% 100%, rgba(191,219,254,0.38) 0%, transparent 42%),
  linear-gradient(180deg, #F8FCFF 0%, #EAF8FF 52%, #F9FEFF 100%)
`;
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: 'inset 0 0 60px rgba(125,211,252,0.05), inset -3px 0 10px rgba(56,189,248,0.04)',
        backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 28px, rgba(56,189,248,0.014) 28px, rgba(56,189,248,0.014) 29px)',
      }}
    >
      {storyMode && animCSS && (
      ...
      >
        {imageUrl ? (
          ...
          <div style={{ width: '100%', height: '100%', padding: 16, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            <p style={{ fontSize: 11, color: '#0284C7', marginTop: 6, fontWeight: 600, textAlign: 'center' }}>
      ...
      <div
        style={{
          ...
          alignItems: 'center',
          borderTop: '1px solid rgba(147,197,253,0.10)',
          flexShrink: 0,
        }}
      >
        <span style={{ fontSize: 10, fontWeight: 700, color: '#0284C7', fontVariantNumeric: 'tabular-nums' }}>
          {pageNum}
        </span>
      </div>
      ...
      <div
        style={{
          ...
          background: pageNum % 2 === 1
            ? 'linear-gradient(to left, rgba(56,189,248,0.08), transparent)'
...
const TBtn: React.FC<{
  ...
  const baseBg = active
    ? 'linear-gradient(135deg, rgba(103,232,249,0.9), rgba(59,130,246,0.85))'
    : 'rgba(255,255,255,0.86)';
  const baseColor = active ? '#FFFFFF' : '#0F172A';
  return (
    <motion.button
      onClick={onClick}
      disabled={disabled}
      ...
      style={{
        ...
        background: baseBg,
        color: baseColor,
        border: active ? '1px solid rgba(59,130,246,0.28)' : '1px solid rgba(147,197,253,0.55)',
        boxShadow: active ? '0 8px 18px rgba(59,130,246,0.20)' : 'none',
      }}
      whileHover={!disabled ? { scale: 1.06, backgroundColor: 'rgba(239,246,255,0.96)' } : {}}
  ...
  return (
    <div
      style={{
        ...
        background: 'rgba(255,255,255,0.84)', border: '1px solid rgba(147,197,253,0.45)',
      }}
    >
      {modes.map((m) => (
        <motion.button
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 16px 42px rgba(59,130,246,0.12)',
        overflow: 'hidden',
      }}
    >
      <div style={{
        ...
        <h4 style={{ fontSize: 13, fontWeight: 800, color: '#0F172A', margin: 0 }}>📊 Reading Stats</h4>
        <motion.button
          onClick={onClose}
          style={{
      ...
      <div style={{ padding: '12px 16px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
        {items.map((item) => (
          <div key={item.label} style={{
            ...
            background: 'rgba(255,255,255,0.9)', border: '1px solid rgba(147,197,253,0.3)',
            textAlign: 'center',
          }}>
            <span style={{ fontSize: 18 }}>{item.emoji}</span>
            <p style={{ fontSize: 14, fontWeight: 900, color: '#0F172A', margin: '2px 0 0' }}>{item.value}</p>
            <p style={{ fontSize: 9, color: '#3B82F6', fontWeight: 600, margin: 0 }}>{item.label}</p>
          </div>
        ))}
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <header
        style={{
          height: TOOLBAR_H,
          background: 'linear-gradient(135deg, rgba(255,255,255,0.94), rgba(238,248,255,0.92))',
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0, flex: '0 1 auto' }}>
          <motion.button
            ...
            style={{
              ...
              background: 'rgba(255,255,255,0.95)', border: '1px solid rgba(147,197,253,0.55)',
              flexShrink: 0,
            }}
            whileHover={{ scale: 1.05, x: -2 }}
            whileTap={{ scale: 0.94 }}
          >
            <Icon name="back" size={14} className="text-sky-600" />
            <span style={{ fontSize: 11, fontWeight: 600, color: '#0F172A' }} className="hidden sm:inline">Back</span>
          </motion.button>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }} className="hidden sm:block">
              <h1 style={{ fontSize: 13, fontWeight: 800, color: '#0F172A', margin: 0, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                {book.title}
              </h1>
              <p style={{ fontSize: 10, color: '#475569', fontWeight: 600, margin: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 2, flex: '0 1 auto' }}>
          ...
          {/* Separator */}
          <div style={{ width: 1, height: 24, background: 'rgba(147,197,253,0.35)', margin: '0 2px' }} className="hidden lg:block" />

          {/* Zoom controls */}
          <TBtn emoji="➖" onClick={zoomOut} tooltip={`Zoom Out (${Math.round(zoomLevel * 100)}%)`} disabled={zoomLevel <= 0.8} />
          <span style={{ fontSize: 10, fontWeight: 700, color: '#0F172A', minWidth: 34, textAlign: 'center', userSelect: 'none' }}>{Math.round(zoomLevel * 100)}%</span>
      ...
      <div style={{ height: PROGRESS_H, background: 'rgba(186,230,253,0.58)', position: 'relative', overflow: 'hidden', flexShrink: 0, borderRadius: 99 }}>
        <motion.div
          style={{ height: '100%', background: 'linear-gradient(90deg, #38BDF8, #0EA5E9, #3B82F6)', borderRadius: 99 }}
          initial={{ width: '0%' }}
        ...
        {progressPercent > 5 && (
          <span style={{
            ...
            color: '#0F172A', lineHeight: 1, paddingRight: 4,
          }}>
            {progressPercent}%
          </span>
        )}
        ...
        <div style={{
          ...
          <div
            style={{
              ...
              background: 'radial-gradient(ellipse at center, rgba(186,230,253,0.42) 0%, rgba(219,234,254,0.20) 55%, transparent 72%)',
            }}
          >
            ...
            {false && (
              <motion.div style={{ textAlign: 'center', maxWidth: 320, padding: '0 24px' }} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <h2 style={{ fontSize: 18, fontWeight: 900, color: '#0F172A', marginBottom: 8 }}>Unable to load book</h2>
                ...
                <motion.button onClick={onBack} style={{
                  ...
                  background: 'linear-gradient(135deg, #38BDF8, #3B82F6)', color: '#fff', fontSize: 13, fontWeight: 700,
                  border: 'none', cursor: 'pointer', boxShadow: '0 4px 12px rgba(59,130,246,0.24)',
              ...
              <motion.div style={{ textAlign: 'center' }} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}>
                <motion.div
                  style={{
                    ...
                    borderRadius: '50%', border: '3px solid #DBEAFE', borderTopColor: '#38BDF8',
                  }}
                  animate={{ rotate: 360 }}
                  transition={{ duration: 0.9, repeat: Infinity, ease: 'linear' }}
                />
                <p style={{ fontSize: 13, fontWeight: 600, color: '#0F172A', marginTop: 20 }}>Preparing your animated storybook…</p>
                <p style={{ fontSize: 11, color: '#475569', marginTop: 6 }}>{book.title}</p>
              </motion.div>
            )}
              ...
              <>
                ...
                {!isMobile && (
                  <motion.button
                    ...
                    style={{
                      ...
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      cursor: 'pointer',
                      background: 'rgba(255,255,255,0.9)', border: '1px solid rgba(147,197,253,0.36)',
                      boxShadow: '0 10px 24px rgba(59,130,246,0.14)',
                      opacity: displayPage <= 1 ? 0.15 : 1,
                      transition: 'transform 0.2s, box-shadow 0.2s, opacity 0.3s',
                    }}
                    whileHover={displayPage > 1 ? { scale: 1.12, x: -4, boxShadow: '0 14px 28px rgba(59,130,246,0.22)' } : {}}
                    whileTap={displayPage > 1 ? { scale: 0.88 } : {}}
                  >
                    <Icon name="chevron-left" size={26} className="text-sky-600" />
                  </motion.button>
                )}
                ...
                <motion.div
                  ...
                  onDoubleClick={zoomReset}
                    ...
                    boxShadow: zoomLevel > 1
                      ? '0 30px 80px rgba(59,130,246,0.16), 0 12px 30px rgba(59,130,246,0.08)'
                      : '0 20px 60px rgba(59,130,246,0.10), 0 8px 24px rgba(59,130,246,0.06)',
                ...
                >
                  ...
                  {!isMobile && (
                    <div style={{
                      ...
                      background: 'linear-gradient(90deg, rgba(125,211,252,0.10), rgba(186,230,253,0.03), rgba(125,211,252,0.10))',
                      zIndex: 10,
                      pointerEvents: 'none',
                    }} />
                  )}
                ...
                {!isMobile && (
                  <motion.button
                    ...
                    whileHover={displayPage < numPages ? { scale: 1.12, x: 4, boxShadow: '0 14px 28px rgba(59,130,246,0.22)' } : {}}
                    whileTap={displayPage < numPages ? { scale: 0.88 } : {}}
                  >
                    <Icon name="chevron-right" size={26} className="text-sky-600" />
                  </motion.button>
                )}
              </>
            )}
          ...
          {numPages > 0 && !isLoading && isMobile && !isFullscreen && (
            <div
              style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'space-between',
                padding: '8px 12px',
                background: 'rgba(255,255,255,0.88)', borderTop: '1px solid rgba(147,197,253,0.22)',
            ...
            >
              <motion.button onClick={flipPrev} disabled={displayPage <= 1}
                style={{
                  ...
                  background: 'rgba(219,234,254,0.9)', color: '#0F172A', fontSize: 11, fontWeight: 700,
          ...
          {numPages > 0 && !isLoading && (
            ...
            >
              ...
              <div style={{
                ...
                background: 'rgba(224,242,254,0.9)', border: '1px solid rgba(56,189,248,0.28)',
              }}>
                <span style={{ fontSize: 11, fontWeight: 700, color: '#0F172A' }}>Page</span>
                {pageJumpEditing ? (
                  <input
                    type="number"
                    autoFocus
                    ...
                    style={{
                      ...
                      border: '2px solid #38BDF8', background: 'rgba(255,255,255,0.98)',
                ...
                <span style={{ fontSize: 12, fontWeight: 700, color: '#0F172A', fontVariantNumeric: 'tabular-nums' }}>{numPages}</span>
              </div>
            </div>
          )}
        </div>
          ...
          {askAIOpen && !askAIMinimized && (
            <motion.div
              ...
              style={{
                flexShrink: 0,
                overflow: 'hidden',
                borderLeft: isMobile ? 'none' : '1px solid rgba(147,197,253,0.18)',
          ...
          <motion.button
            ...
            onClick={handleExpandAI}
              style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                boxShadow: '0 6px 24px rgba(59,130,246,0.26)',
                fontSize: 22,
              }}
