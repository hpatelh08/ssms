...
export const GardenGrowthPage: React.FC = () => {
  ...
  const resp = {
    ...
    breakdown: [
      { label: 'Homework Completion', value: analytics.gardenWater, color: '#6366F1' },
      { label: 'Game Participation',  value: analytics.gardenSunlight, color: '#8B5CF6' },
      { label: 'Daily Practice',      value: analytics.attendanceRate, color: '#A78BFA' },
    ],
  };
