...
const SECTORS = [
  ...
  { name: 'Comet Corridor',   range: '121 – 200', subjects: 'Science + Word',   color: '#A855F7' },
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', paddingBottom: 40 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 24 }}>
        {[
          { icon: '🎯', label: 'Current Level', value: progress.level, color: CLR.indigo, bg: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(129,140,248,0.04))' },
          ...
          { icon: '📊', label: 'Accuracy', value: `${accuracy}%`, color: accuracy >= 70 ? CLR.mint : CLR.rose, bg: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(56,189,248,0.04))' },
        ].map((s, i) => (
          <motion.div
            key={s.label}
