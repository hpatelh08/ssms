...
const GROUNDED_SYSTEM_PROMPT = `You are an intelligent AI assistant for a Smart School System.
...
export const AskAIPanel: React.FC<AskAIPanelProps> = ({
  ...
  const quickActions = [
    ...
    { label: '❓ Practice question', question: 'Generate a simple practice question based on this page for a Class 2 student.' },
  ];
              ...
              style={{
                ...
                background:
                  msg.role === 'user'
                    ...
                    : '#FFFFFF',
                color: msg.role === 'user' ? '#FFFFFF' : '#17331f',
                WebkitTextFillColor: msg.role === 'user' ? '#FFFFFF' : '#17331f',
                opacity: 1,
                mixBlendMode: 'normal',
                fontSize: 14,
                lineHeight: 1.6,
                fontWeight: 500,
                border: msg.role === 'ai' ? '1px solid rgba(244,114,182,0.28)' : 'none',
            ...
            {quickActions.slice(0, 3).map((a) => (
              <motion.button
                ...
                style={{
                  ...
                  border: '1px solid rgba(16,185,129,0.15)',
                  background: 'rgba(16,185,129,0.04)',
                  color: '#2F6F3A', fontSize: 9, fontWeight: 600,
                  cursor: 'pointer',
                }}
