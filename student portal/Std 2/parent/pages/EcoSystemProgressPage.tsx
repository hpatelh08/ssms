...
const WORLDS = [
  ...
  { id: 'science', name: 'Fun Science',       icon: '🔬', color: '#8b5cf6' },
];
  ...
  return (
    <div style={{ maxWidth: 900, margin: '0 auto', paddingBottom: 40 }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 24 }}>
        {[
          { icon: '📚', label: 'Total Levels Done', value: progress.totalCompleted, color: CLR.indigo, bg: 'linear-gradient(135deg, rgba(99,102,241,0.08), rgba(129,140,248,0.04))' },
