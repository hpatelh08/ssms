...
async function generateWorksheetAI(
  ...
  const systemPrompt = `You are an expert Class 2 (age 7-8) worksheet creator for Indian CBSE/NCERT curriculum.
Subject: ${subjectLabel}
Topic: ${topic}
Difficulty: ${difficulty}

Rules:
- Use simple language appropriate for 7-8 year old children
