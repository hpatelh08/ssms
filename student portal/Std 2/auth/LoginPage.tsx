...
const modalCopy = {
  badge: 'Ocean Family Pass',
  title: 'Enter Ocean Parent Key',
  description: 'Confirm family access to open the parent explorer dashboard for',
  label: 'Ocean Parent Key',
  placeholder: 'Enter ocean key',
  helper: 'Use this family key to switch from the student explorer view to the parent dashboard.',
  submit: 'Open Parent Explorer',
};
