...
const AIHelperContainer: React.FC<AIHelperContainerProps> = ({
  ...
  const finalizeFallbackResponse = useCallback((trimmed: string) => {
    const fallback: RAGResponse = {
      ...
      simplified_explanation: 'Please try again.',
      ...
      <div className="text-center space-y-2">
        ...
        >
          ...
          <div className="text-left">
            ...
            <p className="text-[11px] text-gray-400 font-medium">Powered by NCERT Std 2 Textbooks</p>
          </div>
        </motion.div>
        ...
        >
          <span className={`w-2 h-2 rounded-full ${
            ragStatus.embeddingsReady ? 'bg-green-400 animate-pulse' : 
