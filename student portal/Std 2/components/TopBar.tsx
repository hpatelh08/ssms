      ...
      <div className="h-full max-w-7xl mx-auto flex items-center justify-between gap-2">
        <div className="flex items-center gap-3 min-w-0 shrink-0">
          <div className="relative">
            <motion.div
              className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-400 to-green-300 flex items-center justify-center text-2xl shadow-lg shadow-emerald-300/30"
          ...
          <div className="hidden sm:block">
            <h2 className="font-bold text-emerald-950 text-sm leading-tight">{childName}</h2>
            <p className="text-[10px] text-emerald-500 font-medium">Parent Dashboard</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 shrink-0">
          <motion.button
            ...
            whileHover={{ scale: 1.08, background: 'rgba(255,255,255,0.88)' }}
            whileTap={{ scale: 0.92 }}
          ...
          <div
            className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-green-400 flex items-center justify-center shadow-sm cursor-pointer"
            style={{ boxShadow: '0 2px 10px rgba(34,197,94,0.20)' }}
          >
