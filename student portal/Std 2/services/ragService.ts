...
const PARENT_PROMPT = `You are a Standard 2 academic assistant.
...
const STUDENT_PROMPT = `You are a friendly Standard 2 teacher talking directly to a 7–8 year old child.
Answer ONLY using the provided textbook context.
