...
================================
Extracts text from English Class 3.pdf, Mathematics Class 3.pdf,
and Science Class 3.pdf using PyMuPDF, chunks it, and outputs
...
# ─── Configuration ────────────────────────────────────────
PDF_FILES = [
    {"file": "Std 3/English/NCERT_English.pdf", "subject": "English", "skip_pages": 12},
    {"file": "Std 3/Mathematics/NCERT_Mathematics.pdf", "subject": "Math", "skip_pages": 12},
    {"file": "Std 3/Science/NCERT_Science.pdf", "subject": "Science", "skip_pages": 12},
]
...
def main():
    print("📚  SSMS RAG Knowledge Base Builder")
    print("━" * 50)
    ...
    for pdf_config in PDF_FILES:
        ...
        if not file_path.exists():
            print(f"⚠  PDF not found: {file_path} – skipping.")
            continue
        
        print(f"\n📖  Processing: {pdf_config['file']}")
        ...
        doc.close()
        print(f"   ✅  Extracted {subject_chunk_count} chunks for {subject}")
 ...
 *   - NCERT_English.pdf (Std 3)  ({english_count} chunks)
 *   - NCERT_Mathematics.pdf (Std 3)  ({math_count} chunks)
 */
