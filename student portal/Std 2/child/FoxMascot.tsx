    ...
    <div className="fox-mascot-root" style={{
        ...
        {message && (
          <motion.div
            ...
            style={{
              ...
              boxShadow: '0 10px 30px rgba(91,162,176,0.18), 0 0 0 2px rgba(125,213,226,0.18)',
              border: '2.5px solid rgba(125,213,226,0.34)',
      ...
      <motion.div
        ...
        style={{
          ...
          position: 'relative',
          cursor: 'default',
          filter: `drop-shadow(0 0 18px ${expr.glowColor}) drop-shadow(0 12px 24px rgba(97,170,183,0.18))`,
      ...
      >
        ...
        <div style={{
          ...
          boxShadow: `0 10px 28px rgba(91,162,176,0.22), 0 0 24px ${expr.glowColor}`,
          background: 'linear-gradient(145deg, #fff8f0, #ffd9a6)',
        }}>
          {/* Ear wiggle wrapper */}
          <motion.div
