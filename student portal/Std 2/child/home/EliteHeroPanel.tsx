...
const T = {
  ...
  success: '#9de1cf',
  warning: '#ffe3b8',
  textSub: 'rgba(2,48,71,0.78)',
  textBody: 'rgba(11,60,93,0.72)',
  greetingBg: 'rgba(255,255,255,0.34)',
  greetingText: '#0b3c5d',
} as const;
...
function getWeekActivity(): number[] {
  try {
    ...
    if (raw) {
      const parsed = JSON.parse(raw) as { attendance?: string[] };
      const attendance = new Set(
        Array.isArray(parsed.attendance)
          ? parsed.attendance.filter((value): value is string => typeof value === 'string')
          : [],
      );
  ...
  return (
    <div className="relative flex items-center justify-center"
      ...
      <div style={{
        ...
        borderRadius: '50%',
        background: 'radial-gradient(circle, rgba(235,252,255,0.26), transparent 65%)',
        pointerEvents: 'none',
      }} />
      ...
      >
        <svg width={RING_SIZE} height={RING_SIZE} style={{ transform: 'rotate(-90deg)' }}>
          <circle cx={RING_SIZE / 2} cy={RING_SIZE / 2} r={RING_R}
            fill="none" stroke="rgba(2,48,71,0.12)" strokeWidth={RING_STROKE}
          />
          ...
          <defs>
            <linearGradient id="heroRingGrad" x1="0" y1="0" x2="1" y2="1">
              <stop offset="0%" stopColor="#dbfbff" />
              <stop offset="50%" stopColor="#9be0d2" />
              <stop offset="100%" stopColor="#9fd9f0" />
            </linearGradient>
          </defs>
        </svg>
      </motion.div>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        <motion.span
          style={{ fontSize: 34, fontWeight: 900, color: '#023047', lineHeight: 1 }}
          key={displayXP}
        ...
        <span style={{ fontSize: 12, fontWeight: 700, color: 'rgba(11,60,93,0.78)', marginTop: 4 }}>
          / {xpToNext} XP
        </span>
      </div>
  ...
  ({ icon, val, color, delay }) => (
    <motion.div
      ...
      style={{
        ...
        background: 'rgba(255,255,255,0.3)', border: '1px solid rgba(255,255,255,0.42)',
        cursor: 'default',
      }}
    ...
    >
      ...
      <span style={{ fontSize: 18, fontWeight: 900, color: '#023047', lineHeight: 1 }}>{val}</span>
    </motion.div>
  ),
);
...
const DOTS = [
  { top: '14%', left: '5%', size: 6, color: '#dff9ff', dur: 5.5, delay: 0 },
  { top: '70%', right: '6%', size: 5, color: '#98dfcf', dur: 6, delay: 1.8 },
  { bottom: '20%', left: '54%', size: 4.5, color: '#f6d4df', dur: 5, delay: 3 },
];
...
export const EliteHeroPanel: React.FC<EliteHeroPanelProps> = React.memo(({
  ...
  const weekDays = useMemo(getWeekActivity, []);
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        background: `
          radial-gradient(circle at 82% 18%, rgba(255,255,255,0.38), transparent 26%),
          radial-gradient(circle at 20% 30%, rgba(255,255,255,0.22), transparent 30%),
          radial-gradient(circle at 52% 100%, rgba(121,211,199,0.22), transparent 50%),
          linear-gradient(135deg, #62d5ef 0%, #8fe6f2 52%, #b5f3df 100%)
        `,
        boxShadow: '0 20px 44px rgba(0, 150, 199, 0.18), 0 8px 20px rgba(0, 150, 199, 0.1)',
    ...
    >
      ...
      <FloatingBlob size={280} top="-38%" right="-14%"
        color="rgba(255,255,255,0.08)" xRange={16} yRange={12} dur={10}
      />
      <FloatingBlob size={220} bottom="-32%" left="-10%"
        color="rgba(215,247,244,0.09)" xRange={14} yRange={16} dur={8}
      />
      ...
      <div style={{
        ...
        background: 'linear-gradient(90deg, rgba(255,255,255,0.32), rgba(255,255,255,0.18), transparent)',
        pointerEvents: 'none',
      }} />
      ...
      <div className="relative z-10" style={{
        ...
        <div className="flex flex-col gap-3 min-w-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              style={{
                width: 84, height: 84,
                background: 'linear-gradient(135deg, rgba(255,255,255,0.22), rgba(232,250,252,0.1))',
                boxShadow:
                  '0 0 0 6px rgba(255,255,255,0.18), 0 10px 25px rgba(77,176,197,0.30)',
                willChange: 'transform',
              }}
              animate={
                avatarBounce
              ...
              <h1 style={{
                ...
                <motion.span
                  style={{
                    ...
                    height: '40%',
                    background: 'rgba(239,252,255,0.18)',
                    borderRadius: 12,
          ...
          <motion.span
            ...
            style={{
              fontSize: 14, fontWeight: 800, color: '#023047',
        ...
        <div className="flex flex-col items-center justify-center gap-3 min-w-0">
          ...
          <div style={{
            ...
            <AnimatePresence mode="wait">
              <motion.p
                key={motiv.key}
                style={{
                  fontSize: 15, fontWeight: 700, color: '#023047',
          ...
          <div className="flex items-center gap-2 flex-wrap justify-center">
            ...
            <StatChip icon="🎖️" val={badges.length} color="#48cae4" delay={0.6} />
            ...
            {weekDays.map((active, i) => (
              <div key={i} className="flex flex-col items-center gap-0.5">
                <div style={{
                  ...
                  background: active
                    ? 'linear-gradient(135deg, #7ed4e2, #92e0cf)'
                ...
                <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(11,60,93,0.75)' }}>{WEEK_DAYS[i]}</span>
              </div>
            ))}
          </motion.div>
          ...
          >
            <div style={{
              width: 6, height: 6, borderRadius: '50%', background: '#48cae4',
              animation: 'eliteSyncPulse 2s ease-in-out infinite',
            }} />
            <span style={{ fontSize: 12, fontWeight: 700, color: '#023047' }}>Parent Synced ✓</span>
          </motion.div>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <AnimatePresence>
            {justGained && (
              <motion.span
                style={{ fontSize: 18, fontWeight: 900, color: '#0b7285' }}
