    ...
    >
      <div
        ...
        style={{
          ...
          border: '1px solid rgba(182,224,231,0.55)',
      ...
      >
        ...
        <div className="flex items-center gap-3.5 min-w-0 shrink-0">
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #68c7d9 0%, #83ddd2 58%, #f0b7c9 100%)',
          ...
          <div className="relative">
            <motion.button
              ...
              style={{
                ...
                background: 'linear-gradient(135deg, rgba(255,255,255,0.88), rgba(231,248,251,0.88))',
                boxShadow: 'var(--shadow-soft)',
                border: '1px solid rgba(182,224,231,0.48)',
                cursor: 'pointer',
            ...
            <motion.div
              style={{
                ...
                background: 'linear-gradient(135deg, #f5b5c8, #f0d59a)',
                boxShadow: '0 0 8px rgba(240,181,200,0.5)',
            ...
            <AnimatePresence>
              {showNotif && (
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(180deg, rgba(255,255,255,0.97), rgba(240,250,251,0.96))',
                    backdropFilter: 'blur(24px)',
                    border: '1px solid rgba(181,223,230,0.48)',
