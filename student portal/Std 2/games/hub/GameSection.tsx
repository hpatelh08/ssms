...
const WORLD_THEMES: Record<string, WorldTheme> = {
  arcade: {
    bg: 'linear-gradient(170deg, #E6F8FF 0%, #D1F2FF 30%, #BDEBFF 55%, #A8E3FF 80%, #93DBFF 100%)',
    particles: ['🎪', '🎯', '🎨', '🧩', '🎲', '🎈', '🎵', '🌟', '✨', '🎀'],
  ...
  maths: {
    bg: 'linear-gradient(170deg, #E6F8FF 0%, #D4F2FF 30%, #C2ECFF 55%, #AFE5FF 80%, #9BDEFF 100%)',
    particles: ['🔢', '➕', '⭐', '🔷', '📐', '🧮', '💫', '✨', '🌟', '🔶'],
  ...
  science: {
    bg: 'linear-gradient(170deg, #F0FFF4 0%, #DAFCE8 30%, #C6F7D5 55%, #B8F5CD 80%, #A8EFC0 100%)',
    particles: ['🔬', '🧪', '🌿', '🌍', '🦠', '🧬', '💧', '✨', '🌱', '🔭'],
    particleColors: ['rgba(134,239,172,0.18)', 'rgba(74,222,128,0.14)', 'rgba(184,245,205,0.16)', 'rgba(160,232,186,0.14)'],
    headerGlow: '0 4px 30px rgba(134,239,172,0.25), 0 2px 10px rgba(184,245,205,0.2)',
    accentText: '#1A7A42',
    backBorder: 'rgba(26,122,66,0.2)',
    subtitleColor: '#3A9E5F',
  },
};
