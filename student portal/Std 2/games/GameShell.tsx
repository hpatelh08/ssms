...
import { useGameplayTimer } from '../child/useGameplayTimer';
...
export const GameShell: React.FC<Props> = ({
  ...
  const handleSelectLevel = useCallback((level: number) => {
    ...
    setDisabled(false);
    setPhase('playing');
  }, [canEnterGameplay, gameTypeId, difficulty, timeUpMessage]);

  useGameplayTimer({
    isGameplayActive: phase === 'playing' || phase === 'retry',
    onBlocked: () => {
      setTimerNotice(timeUpMessage);
      setPhase('selectLevel');
    },
