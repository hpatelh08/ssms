        ...
        <div style={{
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                cursor: 'pointer', fontWeight: 700, color: 'rgba(0,0,0,0.6)',
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <h3 style={{ margin: 0, fontSize: 18, fontWeight: 900, color: '#1a1a2e', letterSpacing: '0.02em' }}>
                {meta.label} Levels
              </h3>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 2 }}>
              <span style={{ fontSize: 20, fontWeight: 900, color: '#A78BFA' }}>
                {pct}%
              </span>
              <span style={{ fontSize: 10, fontWeight: 700, color: 'rgba(167,139,250,0.6)' }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: 11, color: 'rgba(124,58,237,0.7)' }}>
