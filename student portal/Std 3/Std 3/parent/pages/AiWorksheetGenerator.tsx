...
async function generateWorksheetAI(
  ...
  const systemPrompt = `You are an expert Class 3 (age 8-9) worksheet creator for Indian CBSE/NCERT curriculum.
...
function generateFallbackQuestions(
  ...
  if (wsType === 'mcq') {
    const templates = [
      ...
      { q: `Which subject does "${topic}" belong to?`, opts: ['English', 'Maths', 'EVS', 'Art'], ans: 0 },
