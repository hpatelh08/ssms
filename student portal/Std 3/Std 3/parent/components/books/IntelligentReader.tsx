          ...
          <div className="flex items-center gap-1.5">
            ...
            >
              ...
              <button
                ...
                className="px-2 py-0.5 text-xs font-bold text-gray-700 tabular-nums cursor-pointer hover:bg-white/60 rounded-xl transition-colors"
              >
                {currentPage}{' '}
            ...
            <div className="flex items-center gap-0.5">
              ...
              <button
                onClick={zoomReset}
                className="px-2 py-0.5 text-[11px] font-bold text-gray-600 tabular-nums cursor-pointer hover:bg-white/60 rounded-xl transition-colors min-w-[44px] text-center"
              >
                {Math.round(zoom * 100)}%
              </button>
              <ToolbarBtn
