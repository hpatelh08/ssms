  ...
  return (
    <>
      ...
      <div className="bg-white/75 backdrop-blur-2xl border border-white/40 p-8 sm:p-10 rounded-[24px] text-center max-w-md mx-auto relative overflow-hidden shadow-xl">
        <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-violet-400 to-purple-500 rounded-full opacity-10 blur-3xl pointer-events-none" />
        ...
        >
          ...
          <motion.div
            className="inline-block bg-gradient-to-r from-violet-500 to-purple-500 text-white font-black text-xl px-6 py-2 rounded-2xl shadow-lg shadow-violet-500/20"
              ...
              <motion.button
                ...
                className={`relative flex flex-col items-center justify-center p-5 rounded-2xl border-2 transition-all ${
                  showResult && isCorrect
                    ...
                    : 'border-gray-100/40 bg-white/50 hover:border-violet-200/60 hover:bg-violet-50/20'
                }`}
