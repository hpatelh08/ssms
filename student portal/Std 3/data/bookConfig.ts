...
const ncertBooks: BookEntry[] = [
  /* ── Main subjects (top row) ── */
  {
    ...
    accentColor: '#f59e0b',
    pdfUrl: '/books/ncert-std3/english.pdf',
    chapters: [
  ...
  },
  {
    ...
    accentColor: '#6366f1',
    pdfUrl: '/books/ncert-std3/mathematics.pdf',
    chapters: [
  ...
  },
  {
    ...
    accentColor: '#06b6d4',
    pdfUrl: '/books/ncert-std3/science.pdf',
    chapters: [
  ...
  },
  {
    ...
    accentColor: '#10b981',
    pdfUrl: '/books/ncert-std3/hindi.pdf',
    chapters: [
  ...
  /* ── Other subjects (bottom row) ── */
  {
    ...
    accentColor: '#8b5cf6',
    pdfUrl: '/books/ncert-std3/arts-bansuri.pdf',
    chapters: [
      { id: 'na-1', name: 'Unit 1' },
      { id: 'na-2', name: 'Unit 2' },
      { id: 'na-3', name: 'Unit 3' },
  ...
  },
  {
    ...
    accentColor: '#f43f5e',
    pdfUrl: '/books/ncert-std3/khel-yoga.pdf',
    chapters: [
      { id: 'np-1', name: 'Unit 1' },
      { id: 'np-2', name: 'Unit 2' },
      { id: 'np-3', name: 'Unit 3' },
...
const stateBooks: BookEntry[] = [
  {
    ...
    accentColor: '#ec4899',
    pdfUrl: '/books/gseb-std3/gujarati.pdf',
    chapters: [
