...
/** Subject curriculum data (Std 3 NCERT). */
...
export const BASELINE_MILESTONES: MockMilestone[] = [
  ...
  { id: 'm6', title: 'Reading Explorer',  description: 'Completed the first book reading session', icon: 'book', date: '2026-02-25', category: 'milestone' },
];
