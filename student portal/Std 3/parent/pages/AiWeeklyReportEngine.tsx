...
async function generateAINarrative(
  ...
  const prompt = `You are an AI learning coach writing a weekly report for a parent about their Class 3 (age 8-9) child named ${studentName}.
          ...
          >
            ...
            <div className="grid grid-cols-3 gap-4">
              {[
                ...
                { label: 'Reading Sessions', value: String(readingInsights.totalSessions), color: COLORS.mint },
