...
const SPACE_READER_BG = `
  radial-gradient(circle at 18% 14%, rgba(56,189,248,0.2) 0%, transparent 28%),
  radial-gradient(circle at 82% 8%, rgba(168,85,247,0.2) 0%, transparent 24%),
  radial-gradient(circle at 50% 100%, rgba(30,64,175,0.2) 0%, transparent 42%),
