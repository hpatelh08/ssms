  ...
  return (
    ...
    >
      <div style={{
        ...
        boxShadow: `0 14px 30px ${theme.glow}, 0 4px 14px rgba(2,6,23,0.32), inset 0 1px 0 rgba(255,255,255,0.08)`,
        transition: 'background 0.3s, border-color 0.3s',
      }}>
        <div style={{ position: 'absolute', width: 12, height: 12, borderRadius: '50%', background: 'rgba(2,6,23,0.26)', right: 14, top: 9 }} />
        <div style={{ position: 'absolute', width: 8, height: 8, borderRadius: '50%', background: 'rgba(2,6,23,0.2)', right: 32, top: 25 }} />
        ...
        <div>
          ...
          {expired ? (
            <p style={{ margin: 0, fontSize: 9, color: theme.sub, fontWeight: 700 }}>Come back tomorrow!</p>
          ) : (
