...
export const WORLD_THEMES: Record<number, WorldTheme> = {
  ...
  0: {
    ...
    particleColors: ['#f9a8d4', '#b7d8a7', '#a7f3d0'],
    headingColor: '#4a3dff',
    bodyColor: '#6f75ff',
    accentColor: '#5b3fff',
    ...
    nodeColors: {
      available: 'linear-gradient(135deg, #b7d8a7, #a7c97f)',
      completed: 'linear-gradient(135deg, #fde68a, #fbbf24)',
      boss: 'linear-gradient(135deg, #f9a8d4, #f472b6)',
      border: 'rgba(167,201,127,0.4)',
      path: 'rgba(167,201,127,0.20)',
      text: '#5b3fff',
  ...
  1: {
    ...
    baseGradient: 'linear-gradient(170deg, #1e1b4b 0%, #312e81 20%, #4338ca 45%, #3f8f3a 70%, #8fcf94 100%)',
    radialGlow: 'radial-gradient(ellipse 60% 50% at 70% 30%, rgba(127,174,101,0.20), transparent 70%)',
    particleColors: ['#8fcf94', '#a7c97f', '#67e8f9'],
    headingColor: '#4a3dff',
    bodyColor: '#c7d2fe',
    accentColor: '#8fcf94',
    glowColor: 'rgba(127,174,101,0.5)',
    tileGradients: {
      available: 'linear-gradient(145deg, rgba(63,143,58,0.20) 0%, rgba(127,174,101,0.12) 100%)',
      completed: 'linear-gradient(145deg, rgba(251,191,36,0.22) 0%, rgba(245,158,11,0.14) 100%)',
      boss: 'linear-gradient(145deg, rgba(167,201,127,0.28) 0%, rgba(95,139,61,0.18) 100%)',
      locked: 'linear-gradient(145deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.02) 100%)',
    },
    starColor: '#fbbf24',
    ringColor: '#fbbf24',
    progressGradient: 'linear-gradient(90deg, #3f8f3a, #8fcf94, #a5b4fc)',
    badgeBg: 'rgba(63,143,58,0.15)',
    nodeColors: {
      available: 'linear-gradient(135deg, #6c63ff, #5b3fff)',
      completed: 'linear-gradient(135deg, #fde68a, #f59e0b)',
      boss: 'linear-gradient(135deg, #a7c97f, #4d7a38)',
      border: 'rgba(63,143,58,0.35)',
      path: 'rgba(127,174,101,0.18)',
      text: '#ffffff',
  ...
  3: {
    ...
    baseGradient: 'linear-gradient(170deg, #0f0720 0%, #1e0a3e 20%, #3b0764 45%, #6b21a8 70%, #7aa344 100%)',
    radialGlow: 'radial-gradient(ellipse 55% 50% at 60% 40%, rgba(122,163,68,0.22), transparent 70%)',
    particleColors: ['#7aa344', '#e879f9', '#22d3ee'],
    headingColor: '#7aa344',
    bodyColor: '#d8b4fe',
    accentColor: '#7aa344',
    glowColor: 'rgba(122,163,68,0.5)',
    tileGradients: {
      available: 'linear-gradient(145deg, rgba(122,163,68,0.20) 0%, rgba(95,139,61,0.12) 100%)',
      completed: 'linear-gradient(145deg, rgba(251,191,36,0.22) 0%, rgba(245,158,11,0.14) 100%)',
      boss: 'linear-gradient(145deg, rgba(232,121,249,0.28) 0%, rgba(122,163,68,0.18) 100%)',
      locked: 'linear-gradient(145deg, rgba(255,255,255,0.04) 0%, rgba(255,255,255,0.02) 100%)',
    },
    starColor: '#fbbf24',
    ringColor: '#e879f9',
    progressGradient: 'linear-gradient(90deg, #4d7a38, #7aa344, #d8b4fe)',
    badgeBg: 'rgba(122,163,68,0.15)',
    nodeColors: {
      available: 'linear-gradient(135deg, #7aa344, #4d7a38)',
      completed: 'linear-gradient(135deg, #e879f9, #d946ef)',
      boss: 'linear-gradient(135deg, #22d3ee, #06b6d4)',
      border: 'rgba(122,163,68,0.35)',
      path: 'rgba(122,163,68,0.18)',
      text: '#ffffff',
