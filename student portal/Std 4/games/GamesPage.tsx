...
import { ENGLISH_CHAPTERS, MATHS_CHAPTERS, type ChapterDef } from './subjects/engine/types';
...
export const GameCenter: React.FC<GameCenterProps> = ({
  ...
  const sectionConfig: Record<'arcade' | 'maths' | 'english', {
    ...
    maths: {
      ...
      groupByChapter: true, chapters: MATHS_CHAPTERS,
    },
    english: {
      ...
      groupByChapter: true, chapters: ENGLISH_CHAPTERS,
    },
  }), []);
