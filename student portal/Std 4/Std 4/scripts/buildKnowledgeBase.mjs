 ...
 * ================================
 * Parses "English Class 4.pdf" and "Mathematics Class 4.pdf"
...
// ─── Configuration ────────────────────────────────────────
const PDF_FILES = [
  { file: 'English Class 4.pdf', subject: 'English', skipPages: 12 },
  { file: 'Mathematics Class 4.pdf', subject: 'Math', skipPages: 12 },
];
 ...
 *   - English Class 4.pdf  (${allChunks.filter(c => c.subject === 'English').length} chunks)
 *   - Mathematics Class 4.pdf  (${allChunks.filter(c => c.subject === 'Math').length} chunks)
 */
