...
export const DifficultySelector: React.FC<Props> = React.memo(({ onSelect, progress }) => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 20, width: '100%', maxWidth: 680, margin: '0 auto', padding: '20px clamp(8px, 2vw, 20px)' }}>
    {/* Title */}
    <div style={{ textAlign: 'center', marginBottom: 8 }}>
      ...
      <p style={{ fontSize: 12, color: '#9CA3AF', marginTop: 4, fontWeight: 600 }}>100 levels per game &bull; 5 questions each</p>
    </div>
