...
export const GAME_CONFIGS: GameConfig[] = [
  { id: 'shapeQuest', seq: 1, icon: '🟰', title: 'Synonym Match', desc: 'Choose the correct synonym word.', gradient: 'from-cyan-500 via-blue-400 to-blue-500', glowColor: 'rgba(6,182,212,0.3)', tag: 'Std 4' },
  { id: 'numberTap', seq: 2, icon: '↔️', title: 'Antonym Match', desc: 'Pick the opposite meaning word.', gradient: 'from-amber-500 via-yellow-400 to-orange-500', glowColor: 'rgba(245,158,11,0.3)', tag: 'Std 4' },
  { id: 'mathPuzzle', seq: 3, icon: '👤', title: 'Pronoun Replace', desc: 'Replace noun with the right pronoun.', gradient: 'from-rose-500 via-rose-400 to-orange-500', glowColor: 'rgba(244,63,94,0.3)', tag: 'Std 4' },
  { id: 'wordBuilder', seq: 4, icon: '⏱️', title: 'Tense Select', desc: 'Select the correct tense in sentence.', gradient: 'from-orange-500 via-amber-400 to-yellow-500', glowColor: 'rgba(249,115,22,0.3)', tag: 'Std 4' },
  { id: 'guessTheWord', seq: 5, icon: '🔢', title: 'Place Value', desc: 'Identify digit place value correctly.', gradient: 'from-green-500 via-emerald-400 to-teal-500', glowColor: 'rgba(16,185,129,0.3)', tag: 'Std 4' },
  { id: 'pictureIdentify', seq: 6, icon: '✖️', title: 'Multiply 2×2', desc: 'Solve two-digit multiplication.', gradient: 'from-amber-500 via-orange-400 to-rose-500', glowColor: 'rgba(245,158,11,0.3)', tag: 'Std 4' },
  { id: 'countObjects', seq: 7, icon: '🍕', title: 'Fraction Compare', desc: 'Compare fractions and choose right one.', gradient: 'from-rose-500 via-pink-400 to-red-500', glowColor: 'rgba(244,63,94,0.3)', tag: 'Std 4' },
  { id: 'matchLetters', seq: 8, icon: '📐', title: 'Area of Rectangle', desc: 'Find rectangle area from sides.', gradient: 'from-teal-500 via-emerald-400 to-green-500', glowColor: 'rgba(20,184,166,0.3)', tag: 'Std 4' },
];
