    ...
    >
      ...
      <motion.div
        className={[
          ...
          bg,
          isToday ? 'ring-2 -amber- ring-offset-2 ring-offset-transparent' : '',
        ].join(' ')}
        style={{
          boxShadow: shadow,
      ...
      >
        ...
        {isToday && (
          <motion.div
            className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full -amber- flex items-center justify-center"
