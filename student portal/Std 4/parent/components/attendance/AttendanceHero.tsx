...
export const AttendanceHero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-16 -left-16 w-48 h-48 bg-gradient-to-br -yellow- -emerald- rounded-full opacity-[0.08] blur-3xl" />
      <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-gradient-to-br -orange- to-pink-300 rounded-full opacity-[0.08] blur-3xl" />
