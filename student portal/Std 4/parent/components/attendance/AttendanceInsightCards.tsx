...
const MonthlyCard: React.FC<{ days: number }> = ({ days }) => {
  ...
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.02, y: -2 }}
    >
      <div className="absolute -bottom-8 -right-8 w-28 h-28 bg-gradient-to-br -amber- -orange- rounded-full opacity-[0.08] blur-2xl" />
      ...
      <div className="flex items-center gap-5 relative z-10">
        ...
        >
          ...
          <span className="text-[11px] font-black -amber- -mt-0.5">{days}</span>
        </motion.div>
