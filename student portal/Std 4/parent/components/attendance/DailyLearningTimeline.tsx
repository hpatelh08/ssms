...
function getStats(day: DayAttendance): StatItem[] {
  return [
    { icon: '🎮', label: 'Games Played', value: day.games, color: '-amber-' },
    { icon: '🎨', label: 'Color Magic', value: day.colorMagic, color: 'text-pink-500' },
    { icon: '🤖', label: 'AI Buddy Sessions', value: day.ncertUsage, color: '-yellow-' },
      ...
      <div className="flex flex-col items-center">
        ...
        <motion.div
          className={[
            ...
            isToday
              ? 'bg-gradient-to-br -amber- -orange-'
              : day.present
        ...
        >
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              {isToday && (
                <span className="text-[10px] font-black -amber- -amber-/60 px-2 py-0.5 rounded-full">
                  📌 Today
                </span>
              )}
              {day.present ? (
          ...
          {!day.present && !isExpanded && (
            <p className="text-[11px] -orange- font-medium mt-1">
