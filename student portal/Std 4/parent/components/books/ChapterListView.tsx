    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          <p className="text-[12px] font-bold text-gray-700 truncate group-hover:-amber- transition-colors">
            {chapter.name}
          </p>
          {/* Stars */}
          {totalStars > 0 && (
        ...
        <div className="flex items-center gap-2 mt-1.5">
          <div className="flex-1 h-1.5 rounded-full bg-gray-100 overflow-hidden">
            <motion.div
              className="h-full rounded-full bg-gradient-to-r from-emerald-400 -yellow-"
              initial={{ width: 0 }}
      ...
      <div className="flex items-center gap-1.5 shrink-0">
        <motion.div
          ...
          className="w-8 h-8 rounded-full -amber- flex items-center justify-center text-sm cursor-pointer hover:-amber-"
          whileHover={{ scale: 1.15 }}
          whileTap={{ scale: 0.9 }}
        >
          🔊
        </motion.div>
        <span className="text-gray-300 text-sm group-hover:-amber- transition-colors">→</span>
      </div>
    </motion.button>
  );
};
