              ...
              loading={
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    <motion.div
                      className="w-8 h-8 rounded-full border-2 -amber- border-t-transparent"
                      animate={{ rotate: 360 }}
                      transition={{
                        duration: 0.8,
                        repeat: Infinity,
...
const FloatingPageIndicator: React.FC<{
  ...
  >
    <span className="text-xs font-black -amber- tabular-nums">
      {current}
    </span>
          ...
          {showGoToPage && (
            ...
            >
              ...
              <input
                ...
                className="w-16 px-2 py-1 rounded-lg border border-gray-200 text-sm text-center font-bold text-gray-700 outline-none focus:-amber-"
                autoFocus
                placeholder="1"
              />
              <button
                onClick={handleGoToPage}
                className="px-3 py-1 rounded-lg -amber- text-white text-xs font-bold cursor-pointer hover:-amber- transition-colors"
              >
                Go
              </button>
            </motion.div>
              ...
              <div className="overflow-y-auto" style={{ maxHeight: 210 }}>
                {bookmarks.map((p) => (
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm cursor-pointer hover:-amber- transition-colors flex items-center justify-between ${
                      p === currentPage
                        ? '-amber- -amber- font-bold'
                        : 'text-gray-600'
                    }`}
                  >
                    <span>Page {p}</span>
                    {p === currentPage && (
                      <span className="text-[10px] -amber-">
                        current
                      </span>
                    )}
                  </button>
          ...
          {pdfError && (
            ...
            >
              <div className="text-center">
                ...
                <motion.button
                  onClick={onClose}
                  className="px-6 py-2.5 rounded-xl -amber- text-white text-sm font-bold cursor-pointer shadow-md"
            ...
            <Document
              ...
              loading={
                ...
                >
                  <div className="text-center">
                    <motion.div
                      className="w-12 h-12 mx-auto rounded-full border-[3px] -amber- border--amber-"
                      animate={{ rotate: 360 }}
                      transition={{
                        duration: 0.9,
                        repeat: Infinity,
