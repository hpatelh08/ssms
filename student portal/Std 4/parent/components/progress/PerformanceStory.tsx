...
export const PerformanceStory: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute -top-10 -left-10 w-36 h-36 bg-gradient-to-br -orange- to-pink-300 rounded-full opacity-[0.07] blur-3xl" />
      <div className="absolute -bottom-8 -right-8 w-28 h-28 bg-gradient-to-br -amber- -orange- rounded-full opacity-[0.06] blur-3xl" />
