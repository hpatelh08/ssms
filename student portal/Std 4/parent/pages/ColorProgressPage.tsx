...
const COLOR_HEX: Record<string, string> = {
  Red: '#EF4444', Blue: '#eab308', Yellow: '#EAB308', Green: '#22C55E',
  Pink: '#EC4899', Purple: '#d97706', Orange: '#F97316',
};
...
const SEVERITY_COLORS: Record<string, { bg: string; border: string; icon: string; text: string }> = {
  ...
  info:    { bg: 'rgba(99,102,241,0.06)', border: 'rgba(99,102,241,0.18)', icon: 'ℹ️', text: CLR.indigo },
};
...
export const ColorProgressPage: React.FC = () => {
  ...
  const summaryMetrics = [
    { icon: '🎨', label: 'Color Visits', value: cs.colorVisits, color: CLR.rose,   gradient: 'linear-gradient(135deg, #FCE7F3 0%, #FDF2F8 100%)' },
    { icon: '🖍️', label: 'Colors Learned', value: cs.colorsLearned, color: CLR.purple, gradient: 'linear-gradient(135deg, #F3E8FF 0%, #fef3c7 100%)' },
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', paddingBottom: 40, position: 'relative' }}>
      ...
      <FloatingParticle delay={1.2} size={60} color="#d97706" left="90%" top="5%" />
      <FloatingParticle delay={2.1} size={55} color="#eab308" left="88%" top="45%" />
      ...
      <GlassCard gradient="linear-gradient(135deg, rgba(236,72,153,0.06), rgba(139,92,246,0.04))" delay={0.1} style={{ marginBottom: 24 }}>
      ...
      <GlassCard gradient="linear-gradient(135deg, rgba(99,102,241,0.06), rgba(56,189,248,0.04))" delay={0.3} style={{ marginBottom: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 14, marginBottom: 24 }}>
        ...
        <GamificationCard icon="🎮" label="Activities Done" value={gam.completedActivities}
          ...
          gradient="linear-gradient(135deg, #fef3c7 0%, #fef3c7 100%)" delay={0.46} />
        <GamificationCard icon="🔥" label="Perfect Streak" value={gam.perfectStreak}
          sub="Consecutive flawless rounds" accent={CLR.rose}
          gradient="linear-gradient(135deg, #FCE7F3 0%, #FFF1F2 100%)" delay={0.5} />
      </div>
