...
const GARDEN_RESPONSIBILITY = {
  ...
  breakdown: [
    { label: 'Homework Completion', value: 82, color: '#f59e0b' },
    { label: 'Game Participation',  value: 68, color: '#d97706' },
    { label: 'Daily Practice',      value: 71, color: '#fcd34d' },
  ],
};
...
const GARDEN_CARE_FACTORS = [
  { icon: '💧', label: 'Water Level', sub: 'Homework',   value: garden.factors.water,     color: '#eab308', tooltip: 'Water Level increases when homework activities are completed.' },
...
const PASTEL: Record<string, string> = {
  ...
  indigo:  'linear-gradient(135deg, #fef3c7 0%, #F3E8FF 50%, #FCE7F3 100%)',
  purple:  'linear-gradient(135deg, #F3E8FF 0%, #fef3c7 50%, #fef3c7 100%)',
};
...
export const GardenGrowthPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', paddingBottom: 40, position: 'relative' }}>
      ...
      <FloatingParticle delay={1.5} size={60} color="#fcd34d" left="88%" top="6%" />
