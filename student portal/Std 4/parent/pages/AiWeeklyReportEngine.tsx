...
const PIE_COLORS = ['#f59e0b', '#F59E0B', '#10B981', '#EC4899', '#38BDF8'];
...
async function generateAINarrative(
  ...
  const prompt = `You are an AI learning coach writing a weekly report for a parent about their Class 4 (age 6-7) child named ${studentName}.
...
const ChartTooltip: React.FC<{ active?: boolean; payload?: Array<{ value: number }>; label?: string }> = ({ active, payload, label }) => {
  ...
  return (
    <div style={{
      ...
      <p style={{ fontSize: 11, fontWeight: 700, color: '#f59e0b', margin: 0 }}>{label}</p>
      ...
      >
        {tabs.map(tab => (
          <motion.button
            ...
            style={{
              background: activeTab === tab.key ? 'linear-gradient(135deg, #f59e0b, #fbbf24)' : 'rgba(255,255,255,0.5)',
            ...
            <div className="rounded-3xl p-6" style={glass}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col items-center justify-center p-4 rounded-2xl" style={{ background: 'rgba(99,102,241,0.04)' }}>
                  ...
                  <p className="text-[15px] font-black -amber- text-center">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <div className="w-11 h-11 rounded-2xl flex items-center justify-center text-xl"
                  style={{ background: 'linear-gradient(135deg, #fbbf24, #fcd34d)', boxShadow: '0 4px 16px rgba(129,140,248,0.25)' }}>
                  🤖
                </div>
                <div>
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  ...
                  { icon: '📖', text: 'Continue the reading habit — aim for at least 2 story sessions this week', color: '#f59e0b' },
