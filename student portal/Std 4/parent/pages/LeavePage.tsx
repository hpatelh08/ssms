...
export default function LeavePage() {
  ...
  const visibleError = error && !isNotFoundError(error) ? error : '';

  return (
    <div className="space-y-6">
      <div className="rounded-[28px] bg-gradient-to-r from-indigo-500 via-blue-500 to-cyan-500 p-6 md:p-7 text-white shadow-[0_18px_48px_rgba(79,70,229,0.24)]">
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full bg-indigo-400/15 px-3 py-1 text-xs font-bold tracking-[0.24em] uppercase text-indigo-100">
      ...
      <form onSubmit={handleSubmit} className="rounded-[28px] border border-indigo-100 bg-white/95 p-5 md:p-6 shadow-lg">
        ...
        <div className="mt-5 grid gap-4 md:grid-cols-2">
          <label className="space-y-2">
            ...
            <select
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
            >
          ...
          <label className="space-y-2 md:col-span-2">
            ...
            <div className="flex items-center gap-3 rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-4 py-4">
              ...
              <input
                ...
                className="w-full text-sm text-slate-600 w-full text-sm text-slate-600 file:mr-4 file:rounded-full file:border-0 file:bg-indigo-500 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white hover:file:bg-indigo-600"
              />
            </div>
        ...
        <div className="mt-5 flex flex-wrap items-center gap-3">
          <button
            type="submit"
            disabled={loading}
            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-indigo-500 to-cyan-500 px-5 py-3 text-sm font-bold text-white shadow-lg shadow-indigo-200 transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-5 py-3 text-sm font-semibold text-indigo-700 hover:bg-indigo-100"
          >
      ...
      <div className="rounded-[28px] border border-indigo-100 bg-white/95 shadow-lg overflow-hidden">
        <div className="flex flex-col gap-2 border-b border-indigo-100 px-5 py-4 md:flex-row md:items-center md:justify-between">
          <div>
