...
const SUBJECT_STATUS: Record<string, { label: string; color: string }> = {
  'English':  { label: 'Improving',       color: '#f59e0b' },
...
const SkillRadar: React.FC<{ skills: { skill: string; value: number }[]; size?: number }> = ({ skills, size = 220 }) => {
  ...
  return (
    <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
      ...
      <motion.polygon points={dataPts} fill="url(#radarFillProg)" stroke="#fbbf24" strokeWidth={2.5}
...
export const ProgressPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 1000, margin: '0 auto', paddingBottom: 40, position: 'relative' }}>
      ...
      {/* Floating particles */}
      <FloatingParticle delay={0} size={80} color="#fbbf24" left="5%" top="2%" />
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 4 }}>
                  <svg width="12" height="12" viewBox="0 0 16 16" fill="none">
                    <path d="M8 1L10 5.5L15 6.2L11.5 9.5L12.4 14.5L8 12.2L3.6 14.5L4.5 9.5L1 6.2L6 5.5L8 1Z" fill="#fbbf24" />
                  </svg>
