...
/** Subject curriculum data (Std 4 NCERT). */
export const BASELINE_SUBJECTS = [
  ...
  { subject: 'Science', progress: 57, done: 8, total: 14, colorKey: 'emerald' as const },
] as const;
...
export const FLOOR = {
  xp: 0, level: 1, attendanceRate: 0, streakDays: 0, engagementScore: 0, totalSessions: 0,
  avgSessionMin: 16,
  gardenWater: 72,
  gardenSunlight: 80,
  gardenGrowth: 54,
