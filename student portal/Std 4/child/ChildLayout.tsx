...
import ColorMagicPage from './ColorMagicPage';
...
export type ChildScreen = 'home' | 'books' | 'play' | 'odd-one-out' | 'word-builder' | 'journey' | 'garden' | 'color-magic';

const VALID_SCREENS = new Set<ChildScreen>(['home', 'books', 'play', 'odd-one-out', 'word-builder', 'journey', 'garden', 'color-magic']);
