...
export const XP_PER_Q: Record<Difficulty, number> = { easy: 3, intermediate: 7, difficult: 12 };
...
export const DIFF_META: Record<Difficulty, { label: string; emoji: string; gradient: string; ring: string; bg: string }> = {
  easy:         { label: 'Std 7 Foundation',  emoji: '📘', gradient: 'from-green-400 to-emerald-400', ring: 'ring-green-400',  bg: 'bg-green-50' },
  intermediate: { label: 'Std 7 Core',        emoji: '🧠', gradient: 'from-amber-400 to-yellow-400',  ring: 'ring-amber-400',  bg: 'bg-amber-50' },
  difficult:    { label: 'Std 7 Advanced IQ', emoji: '🚀', gradient: 'from-red-400 to-rose-400',      ring: 'ring-red-400',    bg: 'bg-red-50' },
};
