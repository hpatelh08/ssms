...
export const GAME_CONFIGS: GameConfig[] = [
  ...
  { id: 'std7_quiz_challenge', seq: 17, icon: '🧠', title: 'Quiz Challenge', desc: 'Std 7 MCQ challenge across all subjects.', gradient: 'from-emerald-500 via-teal-400 to-cyan-500', glowColor: 'rgba(16,185,129,0.35)', tag: 'STD 7' },
  { id: 'std7_find_mistake', seq: 18, icon: '🔍', title: 'Find the Mistake', desc: 'Spot and correct errors with explanations.', gradient: 'from-amber-500 via-orange-400 to-rose-500', glowColor: 'rgba(249,115,22,0.35)', tag: 'STD 7' },
  { id: 'std7_match_pair', seq: 19, icon: '🔗', title: 'Match the Pair', desc: 'Match concepts using smart pair codes.', gradient: 'from-indigo-500 via-blue-400 to-cyan-500', glowColor: 'rgba(99,102,241,0.35)', tag: 'STD 7' },
];
