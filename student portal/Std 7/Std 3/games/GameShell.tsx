          ...
          >
            {lockMessage && (
              <motion.div
                ...
                animate={{ opacity: 1, y: 0 }}
                className="max-w-[680px] mx-auto mb-4 px-4 py-3 rounded-2xl border border-amber-200/60 bg-gradient-to-r from-amber-50 to-orange-50 text-amber-700 text-sm font-bold text-center"
              >
                {lockMessage}
              </motion.div>
            )}
