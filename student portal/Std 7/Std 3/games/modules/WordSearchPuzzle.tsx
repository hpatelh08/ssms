 ...
 * ==============================
 * Find hidden words in a letter grid for Standard 3.
...
export const WordSearchPuzzleModule: React.FC<GameModuleProps> = React.memo(({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center px-4 py-6">
      ...
      >
        <div className="flex items-center gap-3 bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 px-6 py-2 rounded-full border-2 border-yellow-400/50 shadow-xl">
      ...
      {/* Grid */}
      <motion.div
        className="bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 p-4 rounded-2xl border-4 border-yellow-400/40 shadow-2xl mb-4"
