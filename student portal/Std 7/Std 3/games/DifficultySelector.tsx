...
export const DIFF_META: Record<Difficulty, {
  ...
  easy: {
    label: 'Std 7 Foundation', emoji: '📘', gradient: 'from-green-400 to-emerald-400', ring: 'ring-green-400', bg: 'bg-green-50',
  ...
  intermediate: {
    label: 'Std 7 Core', emoji: '🧠', gradient: 'from-amber-400 to-yellow-400', ring: 'ring-amber-400', bg: 'bg-amber-50',
  ...
  difficult: {
    label: 'Std 7 Advanced IQ', emoji: '🚀', gradient: 'from-rose-400 to-orange-400', ring: 'ring-red-400', bg: 'bg-red-50',
...
export const XP_PER_DIFFICULTY: Record<Difficulty, number> = { easy: 3, intermediate: 7, difficult: 12 };
...
function getUnlockText(difficulty: Difficulty): string {
  if (difficulty === 'intermediate') {
    return 'Complete Std 7 Foundation to unlock Std 7 Core';
  }
  return 'Complete Std 7 Core to unlock Std 7 Advanced IQ';
}
  ...
  <div style={{ display: 'flex', flexDirection: 'column', gap: 20, width: '100%', maxWidth: 680, margin: '0 auto', padding: '0 clamp(8px, 2vw, 20px)' }}>
    ...
    <div style={{ textAlign: 'center', marginBottom: 8 }}>
      ...
      <h3 style={{ fontSize: 15, fontWeight: 900, color: '#4B5563', textTransform: 'uppercase', letterSpacing: '0.18em', margin: 0 }}>
        Choose Std 7 Challenge Level
      </h3>
      <p style={{ fontSize: 12, color: '#9CA3AF', marginTop: 4, fontWeight: 600 }}>Std 7 tuned logic &bull; 100 levels per game &bull; 5 questions each</p>
    </div>
