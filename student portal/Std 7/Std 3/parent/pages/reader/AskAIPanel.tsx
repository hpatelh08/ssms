...
async function askGroqAI(question: string, pageText: string, bookTitle: string, pageNum: number, bookBoard: string): Promise<string> {
  ...
  try {
    const systemPrompt = `You are a friendly, encouraging AI tutor helping a Class 7 student (age 8-9) understand a story from their textbook.
...
export const AskAIPanel: React.FC<AskAIPanelProps> = ({
  ...
  const quickActions = [
    ...
    { label: '❓ Practice question', question: 'Generate a simple practice question based on this page for a Class 7 student.' },
  ];
