 ...
 *
 * Premium EdTech-level flipbook reader for Class 7 NCERT books.
 *
 * Upgrades:
...
const BookReaderPage: React.FC<BookReaderPageProps> = ({ book, onBack }) => {
  ...
  return (
    ...
    >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }} className="hidden sm:block">
              ...
              <p style={{ fontSize: 10, color: '#9CA3AF', fontWeight: 600, margin: 0 }}>
                {book.board === 'ncert' ? 'NCERT' : 'GSEB'} · Class 7
              </p>
            </div>
          </div>
      ...
      <div style={{ height: PROGRESS_H, background: 'rgba(99,102,241,0.06)', position: 'relative', overflow: 'hidden', flexShrink: 0, borderRadius: 99 }}>
        <motion.div
