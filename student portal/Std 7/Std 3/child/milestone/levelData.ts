 ...
 * ─────────────────────────────────────────────────────
 * 50-Level Space Academy — 5 Galaxy Sectors × 10 Missions
 *
 * ⭐ STAR SYSTEM:
...
export const WORLDS: WorldDef[] = [
  {
    id: 'w1', order: 0, name: 'Alpha Nebula', emoji: '🌌',
    bgGradient: 'from-indigo-900/70 via-purple-900/50 to-blue-900/70',
    roadColor: '#67e8f9', tagline: 'Letters & Sounds',
    decoEmojis: ['🌟', '✨', '💫', '🛸', '⭐', '🪐'],
    semiOpen: false,
  },
  {
    id: 'w2', order: 1, name: 'Numeron Station', emoji: '🛰️',
    bgGradient: 'from-blue-900/70 via-cyan-900/50 to-teal-900/70',
    roadColor: '#a78bfa', tagline: 'Numbers & Counting',
    decoEmojis: ['🛰️', '🔭', '☄️', '🌠', '🪐', '⚡'],
    semiOpen: false,
  },
  {
    id: 'w3', order: 2, name: 'Story Galaxy', emoji: '📖',
    bgGradient: 'from-violet-900/70 via-fuchsia-900/50 to-purple-900/70',
    roadColor: '#fbbf24', tagline: 'Reading & Stories',
    decoEmojis: ['🌕', '🌙', '💫', '✨', '🌟', '🛸'],
    semiOpen: true,
  },
  {
    id: 'w4', order: 3, name: 'Discovery Orbit', emoji: '🔬',
    bgGradient: 'from-emerald-900/70 via-teal-900/50 to-cyan-900/70',
    roadColor: '#c084fc', tagline: 'Explore & Discover',
    decoEmojis: ['🪐', '☄️', '🌍', '🔭', '🛰️', '⭐'],
    semiOpen: true,
  },
  {
    id: 'w5', order: 4, name: 'Champion Cosmos', emoji: '🚀',
    bgGradient: 'from-rose-900/70 via-red-900/50 to-orange-900/70',
    roadColor: '#fb923c', tagline: 'Master Everything!',
    decoEmojis: ['🚀', '👑', '🏆', '💫', '🌟', '⭐'],
    semiOpen: true,
  },
];
...
const W1: LvMeta[] = [
  ...
  { title: 'Nebula Boss', emoji: '🌌', unlockHint: 'Defeat the Nebula Boss!', reward: { type: 'title', value: 'Nebula Commander', icon: '👑', label: 'Nebula Commander', magicText: 'You conquered the nebula!' } },
];
...
const W2: LvMeta[] = [
  ...
  { title: 'Station Boss', emoji: '🛰️', unlockHint: 'Conquer the station!', reward: { type: 'title', value: 'Math Captain', icon: '👑', label: 'Station Commander', magicText: 'Commander of Numeron Station!' } },
];
...
const W3: LvMeta[] = [
  ...
  { title: 'Galaxy Boss', emoji: '📖', unlockHint: 'Defeat the Galaxy Boss!', reward: { type: 'title', value: 'Story Captain', icon: '👑', label: 'Galaxy Captain', magicText: 'Master of all stories!' } },
];
...
const W4: LvMeta[] = [
  ...
  { title: 'Orbit Boss', emoji: '🔬', unlockHint: 'Defeat the Orbit Boss!', reward: { type: 'title', value: 'EVS Captain', icon: '👑', label: 'EVS Captain', magicText: 'Master of discoveries!' } },
];
...
const W5: LvMeta[] = [
  ...
  { title: 'Cosmos Boss', emoji: '🚀', unlockHint: 'The final mission!', reward: { type: 'surprise', value: 'Mystery', icon: '🎁', label: 'Ultimate Mystery Reward', magicText: 'Only legends unlock this!' } },
];
