...
/** User-selected spooky forest path background */
const JOURNEY_PATH_BG = '/background/zombie.png';
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* ── Path background image (spooky forest) ── */}
            <div
              className="absolute inset-0"
              style={{
                backgroundImage: `url("${JOURNEY_PATH_BG}")`,
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(180deg, rgba(5,18,16,0.34) 0%, rgba(8,22,18,0.22) 45%, rgba(7,15,20,0.34) 100%)',
                willChange: 'transform',
                transform: 'translateZ(0)',
              }}
            />

            {/* ── World mood gradients (kept subtle over image) ── */}
            <div
              className="absolute inset-0"
              style={{
