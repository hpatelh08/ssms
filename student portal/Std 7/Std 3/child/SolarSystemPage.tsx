...
const SolarSystemPage: React.FC<Props> = ({ onBack }) => {
  ...
  const handleAnswer = useCallback((idx: number) => {
    ...
    console.debug('[GameValidation] solar-system', {
      worldId: world?.id,
      levelNum,
      questionIndex: sub,
      selectedAnswer,
  ...
  }, [picked, questions, sub, showFeedback, score, world, levelNum, daily, triggerMascot, resetQuestionState]);
                ...
                return (
                  <motion.div
                    ...
                    style={{
                      ...
                      background: result === true ? '#22c55e' : result === false ? '#ef4444' : isCurrent ? world.color : 'rgba(255,255,255,0.15)',
                      border: isCurrent && isPending ? `2px solid ${world.color}` : 'none',
