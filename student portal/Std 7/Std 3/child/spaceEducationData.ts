 ...
 * ─────────────────────────────────────────────────────
 * Space & Earth Education — Question bank for Std 7
 *
...
export const WORLDS: EduWorld[] = [
  ...
  { id: 'science', name: 'Fun EVS',          icon: '🔬', color: '#8b5cf6', glowColor: 'rgba(139,92,246,0.3)',  description: 'Gravity, light, magnets & simple machines' },
];
