 ...
 * ─────────────────────────────────────────────────────
 * Space War Education Game Engine — Std 7
 *
...
function generateMathsQuestion(difficulty: number): SpaceQuestion {
  ...
  // All operations for Std 7: addition, subtraction, multiplication, division
