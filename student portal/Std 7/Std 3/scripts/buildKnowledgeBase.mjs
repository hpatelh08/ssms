 ...
 * ================================
 * Parses Std 7 NCERT PDFs (English, Mathematics, Science)
...
const PDF_FILES = [
  { file: 'Std 7/English/NCERT_English.pdf', subject: 'English', skipPages: 12 },
  { file: 'Std 7/Mathematics/NCERT_Mathematics.pdf', subject: 'Math', skipPages: 12 },
  { file: 'Std 7/Science/NCERT_Science.pdf', subject: 'Science', skipPages: 12 },
];
 ...
 *   - Std 7 English  (${allChunks.filter(c => c.subject === 'English').length} chunks)
 *   - Std 7 Mathematics  (${allChunks.filter(c => c.subject === 'Math').length} chunks)
 *   - Std 7 Science  (${allChunks.filter(c => c.subject === 'Science').length} chunks)
 */
