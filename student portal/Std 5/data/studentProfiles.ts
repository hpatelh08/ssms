...
const STUDENT_PROFILES: StudentProfile[] = [{ studentName: 'Yash Patel', className: 'Std 5', admissionNumber: 'ADM-2024-421', grNo: 'GR-5001', studentId: 'STU20240481', password: 'Stu@481', parentName: 'Megha Patel', phone: '+91 98765 43210', dob: '2015-08-12', gender: 'Male', bloodGroup: 'B+', address: 'Satellite Road, Ahmedabad', status: 'Active', parentAccessKey: '0421', grade: 5 }];
const profileById = new Map(STUDENT_PROFILES.map(profile => [profile.studentId.toUpperCase(), profile]));
const PROFILE_OVERRIDES_STORAGE_KEY = 'ssms_std5_student_profile_overrides_v1';
