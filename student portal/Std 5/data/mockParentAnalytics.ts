...
/** Subject curriculum data (Std 5 NCERT). */
export const BASELINE_SUBJECTS = [
  { subject: 'English',  progress: 60, done: 6,  total: 10, colorKey: 'blue'    as const },
  { subject: 'Maths',    progress: 54, done: 7,  total: 15, colorKey: 'indigo'  as const },
  { subject: 'Science',  progress: 45, done: 4,  total: 10, colorKey: 'emerald' as const },
  { subject: 'Hindi',    progress: 63, done: 6,  total: 11, colorKey: 'amber'   as const },
  { subject: 'Gujarati', progress: 51, done: 4,  total: 9,  colorKey: 'purple'  as const },
] as const;
...
export const STRONG_AREAS = [
  ...
  },
  {
    ...
    desc: 'Above average engagement — Space War and creative exercises show strong focus.',
    icon: '🎨',
    accent: '#6366F1',
  },
  {
...
export const SUBJECT_TAGS: Record<string, { tag: string; color: string }> = {
  ...
  'Science':  { tag: 'On Track',         color: '#6366F1' },
