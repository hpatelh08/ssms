    ...
    >
      ...
      <div className="flex items-center gap-1.5 mb-4 w-full">
        {Array.from({ length: totalInLevel }, (_, i) => {
          const roundNum = i + 1;
          const roundResult = questionResults[i] ?? null;
          const isCorrectRound = roundResult === true;
          const isWrongRound = roundResult === false;
          ...
          return (
            <motion.div
              ...
              animate={isCurrent && roundResult === null ? { scale: [1, 1.08, 1] } : {}}
