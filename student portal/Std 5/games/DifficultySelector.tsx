...
export const DIFF_META: Record<Difficulty, {
  ...
  easy: {
    ...
    warmGrad: 'linear-gradient(135deg, #9fd18b, #70b46a)', glowColor: 'rgba(112,180,106,0.34)', accentColor: '#2f6f3d', lightBg: 'rgba(201,231,182,0.2)',
    cardGrad: 'linear-gradient(135deg, rgba(217,240,203,0.45) 0%, rgba(180,221,165,0.24) 50%, rgba(250,255,246,0.78) 100%)',
    cardGradHover: 'linear-gradient(135deg, rgba(217,240,203,0.62) 0%, rgba(180,221,165,0.36) 50%, rgba(250,255,246,0.88) 100%)',
  },
  intermediate: {
    label: 'Intermediate', emoji: '⭐', gradient: 'from-amber-400 to-yellow-400', ring: 'ring-amber-400', bg: 'bg-amber-50',
    warmGrad: 'linear-gradient(135deg, #d9c871, #bca651)', glowColor: 'rgba(188,166,81,0.34)', accentColor: '#6f6b30', lightBg: 'rgba(224,219,163,0.2)',
    cardGrad: 'linear-gradient(135deg, rgba(238,236,197,0.42) 0%, rgba(221,212,158,0.22) 50%, rgba(250,255,246,0.78) 100%)',
    cardGradHover: 'linear-gradient(135deg, rgba(238,236,197,0.6) 0%, rgba(221,212,158,0.34) 50%, rgba(250,255,246,0.88) 100%)',
  },
  difficult: {
    label: 'Difficult', emoji: '🌲', gradient: 'from-emerald-700 to-lime-700', ring: 'ring-emerald-700', bg: 'bg-emerald-50',
    warmGrad: 'linear-gradient(135deg, #4f7f34, #2f6f3d)', glowColor: 'rgba(79,127,52,0.30)', accentColor: '#2f5f3d', lightBg: 'rgba(175,204,153,0.2)',
    cardGrad: 'linear-gradient(135deg, rgba(211,231,194,0.38) 0%, rgba(166,194,141,0.24) 50%, rgba(246,252,242,0.78) 100%)',
    cardGradHover: 'linear-gradient(135deg, rgba(211,231,194,0.56) 0%, rgba(166,194,141,0.34) 50%, rgba(246,252,242,0.88) 100%)',
  },
};
...
interface MiniLevelProgress { completed: boolean; score: number; total: number; stars?: number; }
...
export const DifficultySelector: React.FC<Props> = React.memo(({ onSelect, progress }) => (
  <div style={{ display: 'flex', flexDirection: 'column', gap: 20, width: '100%', maxWidth: 680, margin: '0 auto', padding: '0 clamp(8px, 2vw, 20px)' }}>
    ...
    <div style={{ textAlign: 'center', marginBottom: 8 }}>
      ...
      <h3 style={{ fontSize: 15, fontWeight: 900, color: '#2f5f3d', textTransform: 'uppercase', letterSpacing: '0.18em', margin: 0 }}>
        Choose Difficulty
      </h3>
      <p style={{ fontSize: 12, color: '#6f9074', marginTop: 4, fontWeight: 700 }}>100 levels per game &bull; 5 questions each</p>
    </div>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', alignItems: 'baseline', gap: 10, marginBottom: 4 }}>
                  <p style={{
                    ...
                    color: locked ? '#9CA3AF' : isComplete ? meta.accentColor : '#2f5f3d',
