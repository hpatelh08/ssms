 ...
 * =================================================
 * Proper visual bar charts for Standard 5 data handling.
...
const CHART_THEMES = {
  fruits: {
    items: [
      ...
      { emoji: '🍇', name: 'Grapes', color: '#5F8B3D' },
  ...
  toys: {
    items: [
      ...
      { emoji: '🎨', name: 'Art Kits', color: '#5F8B3D' },
...
export const ChartGameModule: React.FC<GameModuleProps> = React.memo(({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center px-4 py-6">
      ...
      >
        <div className="flex items-center gap-3 bg-gradient-to-r from-blue-900 via-green-900 to-lime-900 px-6 py-3 rounded-full border-2 border-blue-400/50 shadow-xl">
      ...
      {/* Chart */}
      <motion.div
        className="bg-gradient-to-br from-lime-100 via-blue-100 to-green-100 p-6 rounded-3xl border-4 border-blue-300/50 shadow-2xl mb-6"
      ...
      >
        {answerOptions.map((option, i) => (
          <motion.button
            ...
            disabled={isLocked}
            className="py-4 px-6 bg-gradient-to-br from-blue-500 to-green-600 text-white text-xl font-black rounded-xl shadow-lg border-2 border-blue-300/50 disabled:opacity-50 disabled:cursor-not-allowed"
