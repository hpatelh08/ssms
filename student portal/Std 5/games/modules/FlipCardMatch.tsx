 ...
 * ==========================
 * Memory matching game for Standard 5.
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="absolute inset-0 w-full h-full bg-gradient-to-br from-lime-600 via-green-600 to-blue-600 rounded-xl border-2 border-yellow-400/50 shadow-lg flex items-center justify-center"
...
export const FlipCardMatchModule: React.FC<GameModuleProps> = React.memo(({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center px-4 py-6">
      ...
      >
        <div className="flex items-center gap-3 bg-gradient-to-r from-pink-900 via-lime-900 to-green-900 px-6 py-2 rounded-full border-2 border-yellow-400/50 shadow-xl">
      ...
      >
        ...
        <div className="px-3 py-1 bg-green-500/20 border border-green-400/50 rounded-lg text-sm font-bold text-green-300">
          Moves: {moves}
        </div>
      </motion.div>
