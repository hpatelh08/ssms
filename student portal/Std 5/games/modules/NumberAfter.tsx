    ...
    <>
      <motion.div className="mb-6" key={`${state.round}-${q.given}`} initial={{ scale: 0.85, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ type: 'spring', stiffness: 200, damping: 18 }}>
        ...
        <div className="inline-flex items-center gap-3">
          <div className="w-24 h-24 bg-gradient-to-br from-blue-50 to-green-50 rounded-3xl border-2 border-dashed border-blue-200/50 shadow-lg flex items-center justify-center">
          ...
          <div className="w-24 h-24 bg-gradient-to-br from-green-50 to-lime-50 rounded-3xl border-2 border-dashed border-green-200/50 shadow-lg flex items-center justify-center">
