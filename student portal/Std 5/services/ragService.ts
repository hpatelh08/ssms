...
const PARENT_PROMPT = `You are a Standard 5 academic assistant.
...
const STUDENT_PROMPT = `You are a friendly Standard 5 teacher talking directly to a 6–7 year old child.
Answer ONLY using the provided textbook context.
