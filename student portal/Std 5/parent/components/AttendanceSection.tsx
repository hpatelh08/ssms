                  ...
                  >
                    ...
                    {dayData?.present ? (
                      <>
                        ...
                        <p className="text-gray-500">🚀 {dayData.spaceWar} space war</p>
...
const DayCard: React.FC<{
  ...
  const isFuture = day.dateKey > new Date().toISOString().split('T')[0];
        ...
        <div className="flex items-center gap-2.5">
          ...
          {day.present && (
            <span className="text-[10px] font-medium text-gray-400">
              {day.games + day.spaceWar + day.ncertUsage + day.gardenActions} activities
            </span>
          )}
        </div>
        <motion.span
            ...
            <div className="px-4 pb-3">
              {day.present ? (
                <div className="space-y-0.5">
                  <StatRow icon="🎮" label="Games Played" value={day.games} color="text-green-500" />
                  <StatRow icon="🚀" label="Space War Completed" value={day.spaceWar} color="text-red-500" />
  ...
  return (
    <div className="bg-white/50 rounded-2xl p-4 space-y-4">
      ...
      <div className="flex items-center gap-2">
        <span
          className="text-base"
          style={{ filter: 'drop-shadow(0 0 4px rgba(63,143,58,0.2))' }}
        >
          🧠
        </span>
...
const AttendanceSectionInner: React.FC = () => (
  <motion.div
    className="rounded-3xl bg-gradient-to-br from-blue-100 to-lime-100 p-6 shadow-md space-y-6 relative overflow-hidden"
  ...
  >
    ...
    <div className="absolute -bottom-10 -right-10 w-36 h-36 bg-gradient-to-br from-lime-400 to-green-400 rounded-full opacity-[0.06] blur-3xl" />

    {/* Section heading */}
    <div className="relative flex items-center gap-2.5">
      <span
        className="text-xl"
        style={{ filter: 'drop-shadow(0 0 6px rgba(63,143,58,0.25))' }}
      >
        🎒
      </span>
      <div>
