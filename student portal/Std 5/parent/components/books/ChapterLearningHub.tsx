...
const TABS: TabDef[] = [
  ...
  { key: 'quiz',     label: 'Quiz',     icon: '🧠', color: 'from-lime-400 to-pink-400',   lockable: true },
  { key: 'revision', label: 'Revision', icon: '🔁', color: 'from-teal-400 to-emerald-400',  lockable: false },
  { key: 'ai',       label: 'Ask AI',   icon: '🤖', color: 'from-green-400 to-lime-400', lockable: true },
];
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className={`w-9 h-9 rounded-xl bg-gradient-to-br ${book.gradient || 'from-blue-400 to-green-500'} flex items-center justify-center shrink-0`}>
