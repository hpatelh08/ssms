          ...
          >
            ...
            <div className="absolute top-3 right-3 flex gap-1.5">
              <motion.button
                ...
                className="w-7 h-7 rounded-full bg-green-50 flex items-center justify-center text-xs cursor-pointer"
      ...
      <div className="space-y-4">
            ...
            {flashcards.map((_, i) => (
              <div
                ...
                className={`w-2 h-2 rounded-full transition-all ${
                  i === currentCard ? 'bg-green-500 scale-125' : i < currentCard ? 'bg-emerald-400' : 'bg-gray-200'
                }`}
              />
            ))}
          </div>
          ...
          <motion.div
            ...
            style={{
              background: isFlipped
                ...
                : 'linear-gradient(135deg, rgba(63,143,58,0.08), rgba(122,163,68,0.08))',
              border: isFlipped ? '2px solid rgba(16,185,129,0.2)' : '2px solid rgba(63,143,58,0.15)',
        ...
        <div className="flex items-center justify-between">
          ...
          <motion.button
            ...
            className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center text-lg cursor-pointer"
            whileHover={{ scale: 1.15 }}
            whileTap={{ scale: 0.9 }}
          >
            {speaking ? '⏸️' : '🔊'}
          ...
          <motion.button
            ...
            className="px-4 py-2 rounded-2xl text-xs font-bold bg-green-100 text-green-600 cursor-pointer disabled:opacity-30"
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
          >
            Next →
