  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 6px 32px rgba(122,163,68,0.08), 0 2px 8px rgba(0,0,0,0.03)',
      }}
    ...
    >
      {/* Decorative blobs */}
      <div className="absolute -top-10 -left-10 w-36 h-36 bg-gradient-to-br from-lime-300 to-pink-300 rounded-full opacity-[0.07] blur-3xl" />
      <div className="absolute -bottom-8 -right-8 w-28 h-28 bg-gradient-to-br from-green-300 to-lime-300 rounded-full opacity-[0.06] blur-3xl" />

      <div className="relative z-10 flex items-start gap-4">
        {/* Mascot illustration */}
        <motion.div
          className="w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 bg-white/40"
          style={{ boxShadow: '0 2px 12px rgba(122,163,68,0.1)' }}
          animate={{ y: [0, -4, 0] }}
