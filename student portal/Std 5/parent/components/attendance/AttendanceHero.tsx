  ...
  return (
    <motion.div
      ...
      style={{
        ...
        boxShadow: '0 8px 40px rgba(63,143,58,0.08), 0 2px 8px rgba(0,0,0,0.02)',
      }}
    ...
    >
      ...
      <div className="absolute -bottom-12 -right-12 w-40 h-40 bg-gradient-to-br from-lime-300 to-pink-300 rounded-full opacity-[0.08] blur-3xl" />
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow: '0 4px 24px rgba(63,143,58,0.12)',
        }}
