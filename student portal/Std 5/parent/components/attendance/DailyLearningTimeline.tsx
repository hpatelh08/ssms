...
function getStats(day: DayAttendance): StatItem[] {
  return [
    { icon: '🎮', label: 'Games Played', value: day.games, color: 'text-green-500' },
    { icon: '🚀', label: 'Space War', value: day.spaceWar, color: 'text-red-500' },
...
const DayNode: React.FC<{
  ...
  const totalActs = day.games + day.spaceWar + day.ncertUsage + day.gardenActions;
        ...
        >
          ...
          <div className="flex items-center justify-between mb-1">
            <div className="flex items-center gap-2">
              {isToday && (
                <span className="text-[10px] font-black text-green-500 bg-green-100/60 px-2 py-0.5 rounded-full">
                  📌 Today
                </span>
              )}
              {day.present ? (
          ...
          {!day.present && !isExpanded && (
            <p className="text-[11px] text-green-300 font-medium mt-1">
