...
async function askGroqAI(question: string, pageText: string, bookTitle: string, pageNum: number, bookBoard: string): Promise<string> {
  ...
  try {
    const systemPrompt = `You are a friendly, encouraging AI tutor helping a Class 5 student (age 8-9) understand a story from their textbook.
          ...
          >
            ...
            <div
              style={{
                ...
                background:
                  msg.role === 'user'
                    ? 'linear-gradient(135deg, #3F8F3A, #5F8B3D)'
