    ...
    <div style={{ width: '100%' }}>
        ...
        {tabs.map((tab) => (
          <motion.button
            ...
            style={{
              ...
              padding: '8px 6px',
              borderRadius: 12,
              border: activeTab === tab.key ? '1.5px solid rgba(63,143,58,0.3)' : '1.5px solid transparent',
      ...
      <div style={{ padding: '8px 0 4px' }}>
        <div style={{
          ...
          borderRadius: 12,
          border: '1px solid rgba(63,143,58,0.06)',
          padding: '12px 14px',
          position: 'relative',
        }}>
                  ...
                  <div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                      {quiz.options.map((opt, i) => {
                        ...
                        let borderColor = 'rgba(63,143,58,0.08)';
                        ...
                        return (
                          <motion.button
                            ...
                            whileHover={!showResult ? { scale: 1.02, background: 'rgba(63,143,58,0.04)' } : {}}
                            whileTap={!showResult ? { scale: 0.98 } : {}}
                          >
                            <span style={{
                              width: 22, height: 22, borderRadius: 6,
                              background: showResult && isCorrect ? '#10B981' : showResult && isSelected && !isCorrect ? '#EF4444' : 'rgba(63,143,58,0.1)',
                              color: showResult && (isCorrect || isSelected) ? '#fff' : '#3F8F3A',
                              display: 'flex', alignItems: 'center', justifyContent: 'center',
