      ...
      <div className="flex items-center gap-4 p-5">
        ...
        <div className="w-28 h-20 rounded-2xl overflow-hidden shrink-0 relative">
          <img
            ...
            loading="lazy"
          />
          <div className="absolute inset-0 flex items-center justify-center bg-green-500/10 group-hover:bg-green-500/20 transition-colors">
            <div className="w-8 h-8 rounded-full bg-white/90 flex items-center justify-center shadow-md">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="#3F8F3A"><path d="M8 5v14l11-7z" /></svg>
            </div>
          </div>
        </div>

        <div className="flex-1 min-w-0">
          <p className="text-[10px] font-bold text-green-400 mb-1">▶ Up Next</p>
          <h4 className="text-[14px] font-black text-green-600 truncate">{video.title}</h4>
          <p className="text-[11px] text-green-300 font-medium mt-0.5 line-clamp-1">{video.context}</p>
        </div>

        <motion.div
          className="w-10 h-10 rounded-full bg-gradient-to-br from-green-500 to-lime-500 flex items-center justify-center shrink-0 shadow-md"
...
export const LessonVideoPlayer: React.FC<LessonVideoPlayerProps> = ({
  ...
  const accentColor = subject === 'English' ? '#F59E0B' : '#3F8F3A';
  ...
  return (
    <div className="w-full px-2 lg:px-4 py-6 space-y-6 relative max-w-5xl mx-auto">
      ...
      <motion.div
        ...
        animate={{ background: subject === 'English' ? 'rgba(254,249,195,0.08)' : 'rgba(237,233,254,0.08)' }}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1
              ...
              style={{
                background: subject === 'English'
                  ? 'linear-gradient(90deg, #F59E0B, #D97706)'
                  : 'linear-gradient(90deg, #3F8F3A, #5F8B3D)',
      ...
      <motion.div
        ...
        style={{
          background: 'white',
          boxShadow: '0 18px 40px rgba(63,143,58,0.12), 0 6px 16px rgba(63,143,58,0.06)',
          border: '1px solid rgba(255,255,255,0.5)',
        }}
      ...
      >
        {/* Player header */}
        <div className="flex items-center justify-between px-6 py-4" style={{ borderBottom: '1px solid rgba(63,143,58,0.06)' }}>
          <div className="flex items-center gap-3">
            <motion.div
        ...
        {/* Video context */}
        <div className="px-6 py-4" style={{ borderTop: '1px solid rgba(63,143,58,0.06)' }}>
      ...
      {onAskAI && (
        <motion.button
          ...
          style={{
            ...glass,
            background: 'linear-gradient(135deg, rgba(232,246,229,0.9), rgba(224,231,255,0.9))',
        ...
        >
          ...
          <span className="text-[13px] font-black text-green-600">Ask AI Buddy</span>
          <span className="text-[10px] text-green-400 font-medium">— Get help with this lesson</span>
        </motion.button>
      )}
      ...
      <div className="flex items-center justify-center gap-2 pt-4 pb-2">
        ...
        <span className="text-[10px] text-gray-400 font-medium">
          Safe viewing mode · No external links · AI grounded to NCERT Class 5 {subject}
        </span>
      </div>
    </div>
  );
