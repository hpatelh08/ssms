...
const AiHero: React.FC = () => (
  <motion.div
    ...
    style={{
      ...
      boxShadow: '0 10px 36px rgba(63,143,58,0.08)',
    }}
  ...
  >
    ...
    <motion.div
      ...
      style={{ background: 'linear-gradient(135deg, #8fcf94, #3f8f3a)' }}
    ...
    />
    <div className="absolute -top-14 -left-14 w-44 h-44 bg-green-300 rounded-full opacity-[0.05] blur-3xl" />
    ...
    <div className="relative z-10 text-center">
      ...
      <h1
        ...
        style={{
          background: 'linear-gradient(90deg, #3f8f3a, #7aa344, #ec4899)',
    ...
    <div className="w-full px-2 lg:px-4 py-8 space-y-10 relative">
      ...
      <motion.div
        ...
        style={{
          ...
          border: '1px solid rgba(255,255,255,0.55)',
          boxShadow: '0 10px 36px rgba(63,143,58,0.1)',
        }}
        initial={{ opacity: 0, y: 16 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ ...spring, delay: 0.24 }}
        whileHover={{ y: -3, boxShadow: '0 14px 44px rgba(63,143,58,0.16)' }}
        onClick={onOpenAskAI}
      >
        <div className="absolute -top-10 -left-10 w-32 h-32 bg-green-300 rounded-full opacity-[0.06] blur-3xl" />
        ...
        <div className="relative z-10">
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(135deg, #6b5cff, #8fcf94)',
