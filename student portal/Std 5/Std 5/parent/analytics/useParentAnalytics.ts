...
export function useParentAnalytics(): StudentAnalytics {
  ...
  return useMemo<StudentAnalytics>(() => {
    ...
    const allSubjectDefs = [
      ...
      { ...BASELINE_SUBJECTS[3], real: { chaptersCompleted: 0, totalChapters: 11, accuracy: 0, gamesPlayed: 0 } }, // Hindi
      { ...BASELINE_SUBJECTS[4], real: { chaptersCompleted: 0, totalChapters: 9,  accuracy: 0, gamesPlayed: 0 } }, // Gujarati
    ];
