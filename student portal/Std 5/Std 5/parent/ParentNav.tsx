...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'brain-boost', label: 'Brain Boost',    sublabel: 'Think & Learn',  icon: '🧠', gradient: 'from-indigo-400 to-violet-500', glowColor: 'rgba(99,102,241,0.20)',   accentColor: '#6366f1', iconBg: 'rgba(99,102,241,0.10)' },
  { key: 'puzzle-zone', label: 'Puzzle Zone',    sublabel: 'Solve & Explore', icon: '🧩', gradient: 'from-teal-400 to-emerald-500', glowColor: 'rgba(20,184,166,0.20)',   accentColor: '#14b8a6', iconBg: 'rgba(20,184,166,0.10)' },
  { key: 'report',         label: 'Report Card',    sublabel: 'Download PDF',   icon: '📄', gradient: 'from-teal-400 to-cyan-500',    glowColor: 'rgba(20,184,166,0.20)',   accentColor: '#14b8a6', iconBg: 'rgba(20,184,166,0.10)' },
  ...
  <>
    ...
    <motion.aside
      ...
      style={{
        ...
        height: '100vh',
        paddingTop: 0,
        background: 'linear-gradient(180deg, #ede9ff 0%, #f0ecff 40%, #ede9ff 70%, #f5ecf8 100%)',
        backdropFilter: 'blur(32px)',
        WebkitBackdropFilter: 'blur(32px)',
        borderRadius: '0 30px 30px 0',
        boxShadow: '4px 0 32px rgba(200,180,255,0.18), 1px 0 0 rgba(255,255,255,0.6)',
      }}
    >
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(107,92,246,0.10), rgba(129,140,248,0.08))',
          borderRadius: 18,
          padding: '10px 14px',
          border: '1px solid rgba(107,92,246,0.12)',
        }}>
          {/* Avatar */}
          <div style={{
            width: 38, height: 38, borderRadius: '50%',
            background: 'linear-gradient(135deg, #818CF8 0%, #A78BFA 50%, #C084FC 100%)',
            boxShadow: '0 3px 12px rgba(129,140,248,0.35)',
          ...
          <div style={{ minWidth: 0 }}>
            <p style={{ margin: 0, fontSize: 12, fontWeight: 800, color: '#6B5CF6', lineHeight: '16px', whiteSpace: 'nowrap' }}>Guardian Console</p>
            <p style={{ margin: 0, fontSize: 9, fontWeight: 500, color: '#8B7CF6', lineHeight: '14px', whiteSpace: 'nowrap' }}>Std 5 · Analytics View</p>
          </div>
        </div>
      </div>
