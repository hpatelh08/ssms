...
const CARD_BORDER = '1px solid rgba(129,140,248,0.12)';
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, height: 130 }}>
        {data.map((d, i) => {
          const barH = hasAnyData ? Math.max((d.sessions / max) * 90, d.sessions > 0 ? 12 : 0) : 0;
          ...
          return (
            <div key={d.date} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4 }}>
              ...
              <div style={{ width: '100%', maxWidth: 32, borderRadius: 8, background: 'rgba(129,140,248,0.12)', height: 90, position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden' }}>
                <motion.div
                  initial={{ height: 0 }}
                  animate={{ height: barH }}
                  ...
                  style={{
                    ...
                    background: d.sessions > 0
                      ...
                      : 'transparent',
                    boxShadow: d.sessions > 0 ? `0 2px 8px rgba(99,102,241,0.35)` : 'none',
                  }}
                />
              </div>
              <span style={{
...
const SECTION_ORDER: { key: string; icon: string; label: string; gradient: string; border: string }[] = [
  { key: 'english', icon: '📚', label: 'English', gradient: 'linear-gradient(135deg, #EDE9FE 0%, #F3E8FF 100%)', border: '1px solid rgba(129,140,248,0.15)' },
  { key: 'maths',   icon: '🔢', label: 'Maths',   gradient: 'linear-gradient(135deg, #DBEAFE 0%, #E0F2FE 100%)', border: '1px solid rgba(56,189,248,0.15)' },
    ...
    <div style={{ maxWidth: 1450, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexWrap: 'wrap', gap: 12, marginBottom: 20 }}>
        <HeroCard
          ...
          color={CLR.indigo}
          gradient="linear-gradient(135deg, #EDE9FE 0%, #F3E8FF 50%, #FCE7F3 100%)"
        />
        <HeroCard
          icon="🎯"
        ...
        <HeroCard
          ...
          color={CLR.sky}
          gradient="linear-gradient(135deg, #DBEAFE 0%, #E0F2FE 50%, #EFF6FF 100%)"
        />
        <HeroCard
          icon="✅"
