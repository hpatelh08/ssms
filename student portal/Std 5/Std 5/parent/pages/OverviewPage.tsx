  ...
  return (
    <div style={{ maxWidth: 1450, margin: '0 auto', display: 'flex', flexDirection: 'column', gap: 24, position: 'relative' }}>
      ...
      <GlassCard gradient={GRADIENTS.mint} delay={0.16}>
        <SectionTitle icon="🚀" title="Learning Hub Activity" subtitle="How the student engages across all learning sections" />
          ...
          {(() => {
            ...
            return (
              <motion.div style={{
                ...
                border: '1px solid rgba(99,102,241,0.12)', textAlign: 'center',
                ...
                <div style={{ height: 6, borderRadius: 3, background: 'rgba(99,102,241,0.10)', marginTop: 10, overflow: 'hidden' }}>
                  <motion.div style={{ height: '100%', borderRadius: 3, background: 'linear-gradient(90deg, #6366f1, #818cf8)' }}
                    initial={{ width: 0 }} animate={{ width: `${brainPct}%` }} transition={{ duration: 0.8 }} />
                </div>
                <p style={{ fontSize: 10, fontWeight: 700, color: '#6366f1', marginTop: 5 }}>{brainPct}% engagement</p>
              </motion.div>
            );
          })()}
