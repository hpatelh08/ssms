        ...
        {[0, 0.25, 0.5, 0.75, 1].map((f, gi) => {
          ...
          return (
            <g key={gi}>
              ...
              />
              <text x={pad.left - 8} y={y + 4} textAnchor="end" fontSize={9} fill={CLR.soft} fontWeight={600}>
                {Math.round(maxVal * f)}
              </text>
            </g>
          );
        ...
        {data.map((d, i) => {
          ...
          return (
            <g key={d.day}>
              ...
              {/* Day label */}
              <text x={x + barW / 2} y={baseY + 18} textAnchor="middle" fontSize={11} fill={CLR.muted} fontWeight={700}>
                {d.day}
              </text>
