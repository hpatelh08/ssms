...
> Project: Smart School System — Std 5  
> Import Errors: **0** — All imports are valid ✅
...
Copy & paste this **single block** in PowerShell terminal (from project root `e:\SSMS\Std 5`):

```powershell
# ═══════════════════════════════════════════════
# 🧹 CLEANUP — Delete all unused files & folders
# ═══════════════════════════════════════════════

# --- child/ unused files ---
Remove-Item "child\_solar_new_tail.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\SoundTest.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\solarSystemData.ts" -ErrorAction SilentlyContinue
Remove-Item "child\BottomNav.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\FloatingMascot.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\TreeDashboard.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\TreeWorld.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\ColorMagicPage.tsx" -ErrorAction SilentlyContinue
Remove-Item "child\motion\useSoftMotion.ts" -ErrorAction SilentlyContinue

# --- child/ empty folders ---
Remove-Item "child\buddy" -Recurse -Force -ErrorAction SilentlyContinue

# --- components/ unused files ---
Remove-Item "components\HomeworkCard.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\HomeworkHelper.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\HomeworkHelperNew.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\Navigation.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\NavigationNew.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\ParentDashboard.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\ParentDashboardNew.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\AttendanceTracker.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\AttendanceGarden.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\TopBar.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\layout\DashboardLayout.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\Games\GameCenter.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\Games\GameCenterArcade.tsx" -ErrorAction SilentlyContinue
Remove-Item "components\Games\GameCenterNew.tsx" -ErrorAction SilentlyContinue

# --- components/ unused folders (entire trees) ---
Remove-Item "components\Parent" -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item "components\AIHelper" -Recurse -Force -ErrorAction SilentlyContinue

# --- scripts/ (non-runtime build helpers) ---
Remove-Item "scripts" -Recurse -Force -ErrorAction SilentlyContinue

# --- Old git artifact ---
Remove-Item "Smart-School-Systum-Class-1" -Recurse -Force -ErrorAction SilentlyContinue

# --- Build output (regenerate with: npm run build) ---
Remove-Item "dist" -Recurse -Force -ErrorAction SilentlyContinue

Write-Host "✅ Cleanup complete! Deleted ~30 files + 5 folders." -ForegroundColor Green
```
