...
export const GAME_CONFIGS: GameConfig[] = [
  ...
  { id: 'missingNumber',   seq: 2,  icon: '🔢', title: 'Missing Number',   desc: 'Complete the number series',       gradient: 'from-blue-500 via-indigo-400 to-violet-500',  glowColor: 'rgba(99,102,241,0.3)',   tag: 'Numbers' },
  ...
  { id: 'oppositeWords',   seq: 4,  icon: '🔄', title: 'Opposite Words',   desc: 'Choose the opposite word',         gradient: 'from-purple-500 via-violet-400 to-indigo-500',glowColor: 'rgba(139,92,246,0.3)',   tag: 'English' },
  ...
  { id: 'pictureMemory',   seq: 6,  icon: '🖼️', title: 'Picture Memory',   desc: 'Remember and match the pictures',  gradient: 'from-cyan-500 via-blue-400 to-indigo-500',    glowColor: 'rgba(6,182,212,0.3)',    tag: 'Memory' },
  ...
  { id: 'shapeMemory',     seq: 9,  icon: '🔷', title: 'Shape Memory',     desc: 'Remember the shapes',              gradient: 'from-indigo-500 via-purple-400 to-violet-500',glowColor: 'rgba(99,102,241,0.3)',   tag: 'Memory' },
  ...
  { id: 'logicPuzzle',     seq: 14, icon: '🧠', title: 'Logic Puzzle',     desc: 'Solve the logic puzzle',           gradient: 'from-purple-600 via-violet-500 to-indigo-600',glowColor: 'rgba(168,85,247,0.3)',   tag: 'HARD' },
