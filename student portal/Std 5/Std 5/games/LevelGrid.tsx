...
if (typeof document !== 'undefined' && !document.getElementById(LG_ID)) {
  ...
  s.textContent = `
    @keyframes lg-pulse-current {
      0%,100% { transform: scale(1);    filter: drop-shadow(0 0 10px rgba(168,85,247,0.7)) drop-shadow(0 0 20px rgba(168,85,247,0.4)); }
      50%     { transform: scale(1.06); filter: drop-shadow(0 0 20px rgba(168,85,247,1.0)) drop-shadow(0 0 40px rgba(168,85,247,0.5)); }
    }
    ...
    .lg-play-btn {
      ...
      padding: 14px 32px;
      border-radius: 36px;
      box-shadow: 0 8px 24px rgba(168,85,247,0.7), 0 3px 8px rgba(0,0,0,0.4);
      pointer-events: none;
      z-index: 4;
...
const LevelNodeBtn: React.FC<{
  ...
  const tintFilter = isCompleted
    ...
    : isCurrent
    ? 'saturate(1.2) brightness(1.1)'                      /* purple — keep original */
      ...
      {isCurrent && (
        <img
          ...
          style={{
            ...
            pointerEvents: 'none',
            zIndex: 6,
            filter: 'drop-shadow(0 8px 20px rgba(0,0,0,0.5)) drop-shadow(0 0 10px rgba(168,85,247,0.4))',
          }}
        />
      )}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: `0 2px 16px rgba(0,0,0,0.08), 0 4px 20px ${meta.glowColor}33`,
        flexShrink: 0,
        boxSizing: 'border-box',
        width: '100%',
      }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 9 }}>
          <button
            ...
            style={{
              ...
              fontSize: 17, background: 'rgba(255,255,255,0.85)',
              border: '1.5px solid rgba(200,210,230,0.5)',
              cursor: 'pointer', fontWeight: 800, color: '#4B5563', flexShrink: 0,
            }}
          >←</button>
          <div style={{
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <h3 style={{ margin: 0, fontSize: 17, fontWeight: 900, color: '#1F2937' }}>
              {meta.label} Levels
            </h3>
        ...
        <div style={{
          ...
          background: 'rgba(220,230,240,0.4)', overflow: 'hidden', marginBottom: 7,
        }}>
          <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 8, alignItems: 'center' }}>
          ...
          <span style={{ fontSize: 11, fontWeight: 700, color: '#6B7280' }}>{QUESTIONS_PER_MINI} Qs/level</span>
