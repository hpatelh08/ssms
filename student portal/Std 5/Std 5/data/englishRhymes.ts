 ...
 * English rhyme / poem videos for AI Buddy - Class 5
 * Aligned with NCERT Marigold Class 5 poems and age-appropriate content.
 */
...
export const englishRhymes: RhymeEntry[] = [
  {
    ...
    context: 'Poem about creativity - making something beautiful from waste. Vocabulary: scraps, leftover, create, design, colorful for Class 5.',
  },
  {
    id: 'bird_talk',
    ...
    context: 'Poem where birds talk about human habits. Rhyming words, conversation style, opposites (grow/walk, sing/wing) for Class 5.',
  },
  {
    id: 'little_by_little',
    ...
    context: 'Growth of an acorn to oak tree. Vocabulary: acorn, oak, mighty, patient, nature\'s cycle for Class 5.',
  },
  {
    id: 'sea_song',
    title: 'Sea Song Poem 🌊',
    ...
    context: 'Magical poem about finding a seashell that sings. Vocabulary: shell, ocean, waves, whisper, echo, wonder for Class 5.',
  },
  {
    id: 'balloon_man',
    ...
    context: 'Poem about a balloon seller in the market. Vocabulary: market, colourful, floating, prices, children\'s joy for Class 5.',
  },
  {
    id: 'trains_poem',
    title: 'Trains Poem 🚂',
    ...
    context: 'Poem about railways and travel. Vocabulary: engine, carriage, tunnel, bridge, station, journey, far-off places for Class 5.',
  },
];
