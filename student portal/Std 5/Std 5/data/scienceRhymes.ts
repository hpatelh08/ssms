 ...
 * Science (EVS) rhyme / song videos for AI Buddy - Class 5
 * Aligned with NCERT Looking Around Class 5 topics.
 */
...
export const scienceRhymes: RhymeEntry[] = [
  {
    ...
    context: 'Characteristics of living things - grow, breathe, need food, move. Differences from non-living for Class 5.',
  },
  {
    id: 'bird_features',
    ...
    context: 'Different types of beaks and claws. How birds eat, scratch, hold things. Adaptations for Class 5.',
  },
  {
    id: 'our_body',
    ...
    context: 'External and internal body parts. Functions of organs - heart, lungs, stomach. Sense organs for Class 5.',
  },
  {
    id: 'food_groups',
    ...
    context: 'Energy-giving, body-building, protective foods. Balanced diet, nutrients for Class 5.',
  },
  {
    id: 'water_cycle',
    ...
    context: 'Evaporation, condensation, precipitation. Clouds, rain, rivers, seas. Water conservation for Class 5.',
  },
  {
    id: 'solar_system',
    ...
    context: '8 planets, sun, moon. Day and night, seasons, stars. Basic astronomy for Class 5.',
  },
];
