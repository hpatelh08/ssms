 ...
 * Gujarati rhyme / song videos for AI Buddy - Class 5
 * Aligned with GSEB Gujarati Class 5 poems and traditional rhymes.
 */
...
export const gujaratiRhymes: RhymeEntry[] = [
  {
    ...
    context: 'Traditional Gujarati rhyme about moon (Chandlo Mama). Asking for butter and milk. Rhyming words, cultural elements for Class 5.',
  },
  {
    id: 'haathi_raja',
    ...
    context: 'Popular elephant rhyme. Describing elephant\'s features - long trunk, big ears. Animal vocabulary in Gujarati for Class 5.',
  },
  {
    id: 'dholi_ghodo',
    ...
    context: 'White horse rhyme - riding to village and city. Action words, travel vocabulary, rhythmic patterns for Class 5.',
  },
  {
    id: 'chakli_chakli',
    ...
    context: 'Sparrow rhyme - asking what it eats. Grains names (jowar, bajri, wheat). Bird vocabulary for Class 5.',
  },
  {
    id: 'aav_varsad',
    ...
    context: 'Rain invitation rhyme. Calling rain to fill ponds, water fields. Monsoon vocabulary in Gujarati for Class 5.',
  },
  {
    id: 'morli_morli',
    ...
    context: 'Peacock rhyme - describing peacock\'s dance in rain. Colors, feathers, rain joy. Gujarat state bird for Class 5.',
  },
];
