/**
 * data/mathsRhymes.ts
 * Maths rhyme / song videos for AI Buddy - Class 5
 * Aligned with NCERT Math-Magic Class 5 topics.
 */
...
export const mathsRhymes: RhymeEntry[] = [
  {
    ...
    context: 'Learning tables 2-10 with fun rhythms. Skip counting, multiplication facts, mental math for Class 5.',
  },
  {
    id: 'measurement_song',
    ...
    context: 'Length, mass, capacity - centimetres, metres, kilograms, litres. Comparing and estimating for Class 5.',
  },
  {
    id: 'fraction_fun',
    ...
    context: 'Halves, quarters, thirds, eighths. Equal sharing, parts of a whole, pizza examples for Class 5.',
  },
  {
    id: 'money_matters',
    ...
    context: 'Indian currency - rupees and paise. Addition, subtraction, making change, shopping problems for Class 5.',
  },
  {
    id: 'geometry_shapes',
    ...
    context: '2D and 3D shapes - edges, corners, faces. Cube, cuboid, sphere, cylinder. Properties of shapes for Class 5.',
  },
  {
    id: 'data_handling',
    ...
    context: 'Tally marks, pictographs, bar graphs. Collecting and organizing data for Class 5.',
  },
];
