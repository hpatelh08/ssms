/**
 * data/hindiRhymes.ts
 * Hindi rhyme / song videos for AI Buddy - Class 5
 * Aligned with NCERT Veena Class 5 poems.
 */
...
export const hindiRhymes: RhymeEntry[] = [
  {
    ...
    context: 'NCERT Class 5 Hindi poem about a boy named Kakkoo who loves birds. Nature connection, freedom themes for Class 5.',
  },
  {
    id: 'shekhibaaz_makhi',
    ...
    context: 'NCERT poem about a boastful fly. Moral story - don\'t show off. Animal characteristics, humility lesson for Class 5.',
  },
  {
    id: 'chaand_wali_amma',
    ...
    context: 'NCERT poem about an old woman who talks to the moon. Imagination, care, love for Class 5.',
  },
  {
    id: 'man_karta_hai',
    ...
    context: 'NCERT poem about wishes and imagination. What children want to become - bird, butterfly, flower for Class 5.',
  },
  {
    id: 'bahadur_bitto',
    ...
    context: 'NCERT poem about a brave little mouse. Courage, size doesn\'t matter, problem-solving for Class 5.',
  },
  {
    id: 'tipatipva',
    ...
    context: 'NCERT poem about raindrops. Water cycle, monsoon, nature\'s beauty. Onomatopoeia (tip-tip sounds) for Class 5.',
  },
];
