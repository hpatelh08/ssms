  ...
  return (
    <div
      style={{
        minHeight: '100vh',
        background:
          'linear-gradient(180deg,#a7f3d0 0%,#bae6fd 18%,#d9f99d 38%,#bbf7d0 60%,#86efac 100%)',
      }}
    >
      <div
        ref={shellRef}
        ...
        >
          <div
            style={{
              ...
              background: 'linear-gradient(135deg, rgba(37,99,235,0.94), rgba(16,185,129,0.92))',
              ...
              {snapshot.sections.map((section) => (
                <motion.button
                  ...
                  style={{
                    ...
                    background:
                      activeSectionId === section.id
                        ? 'linear-gradient(135deg, rgba(255,255,255,0.36), rgba(255,255,255,0.24))'
                        : 'linear-gradient(135deg, rgba(255,255,255,0.26), rgba(255,255,255,0.16))',
                    padding: '12px 12px',
                    display: 'flex',
                    alignItems: 'center',
                    gap: 12,
                    ...
                    boxShadow:
                      activeSectionId === section.id
                        ? '0 0 0 1px rgba(255,255,255,0.22), 0 10px 18px rgba(15,23,42,0.12)'
