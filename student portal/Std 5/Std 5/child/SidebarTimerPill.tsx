...
export const SidebarTimerPill: React.FC = () => {
  ...
  const gradient = isExpired
    ...
    : 'linear-gradient(135deg, rgba(99,102,241,0.82) 0%, rgba(139,92,246,0.82) 100%)';
  ...
  const glowShadow = isExpired
    ...
    : '0 4px 16px rgba(99,102,241,0.10), inset 0 1px 0 rgba(255,255,255,0.55)';
    ...
    >
      ...
      >
        ...
        <div style={{
          width: '100%',
          height: 4,
          background: !hasStarted ? 'rgba(99,102,241,0.15)' : 'rgba(255,255,255,0.2)',
          borderRadius: 4,
          overflow: 'hidden',
        }}>
          <motion.div
