 ...
 * -----------------------------------------------------
 * 2x2 Premium Action Card Grid - brighter, shinier, premium.
 */
...
const TILES: TileDef[] = [
  ...
  },
  {
    ...
    watermark: '⚡',
    label: 'Brain Boost',
    desc: 'Boost your thinking!',
    xp: '+15 XP',
    screen: 'brain-boost',
    gradient: 'linear-gradient(135deg, #ffe7f3 0%, #ffd3ea 100%)',
  ...
  },
  {
    ...
    xp: '+20 XP',
    screen: 'puzzle-zone',
    gradient: 'linear-gradient(135deg, #d7f5e8 0%, #b8f0d5 100%)',
...
export const SmartActionHub: React.FC<SmartActionHubProps> = React.memo(({ onNavigate }) => {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 w-full" style={{ gap: 20 }}>
        {TILES.map((tile, i) => (
          <div key={tile.label}>
            <SmartTile
              tile={tile}
