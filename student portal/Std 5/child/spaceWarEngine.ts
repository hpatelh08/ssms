 ...
 * ─────────────────────────────────────────────────────
 * Space War Education Game Engine — Std 5
 *
...
const SECTORS: Sector[] = [
  ...
  { name: 'Saturn Ring',    icon: '♄',  color: '#5f8b3d', minLevel: 351, maxLevel: 99999, subjects: ['maths', 'english', 'science'], asteroidSpeed: 0.8, asteroidCount: 5 },
];
...
function generateMathsQuestion(difficulty: number): SpaceQuestion {
  ...
  // All operations for Std 5: addition, subtraction, multiplication, division
...
const ASTEROID_VARIANTS = [
  ...
  { shape: '🟣', color: 'radial-gradient(circle at 30% 30%, #5f8b3d, #4d7a38, #6d28d9)' },
