 ...
 * ─────────────────────────────────────────────────────
 * Space & Earth Education — Question bank for Std 5
 *
...
export const WORLDS: EduWorld[] = [
  ...
  { id: 'mystery', name: 'Space Mysteries',  icon: '🛸', color: '#7aa344', glowColor: 'rgba(122,163,68,0.3)',  description: 'Comets, asteroids, black holes & more' },
  ...
  { id: 'science', name: 'Fun Science',      icon: '🔬', color: '#5f8b3d', glowColor: 'rgba(95,139,61,0.3)',  description: 'Gravity, light, magnets & simple machines' },
];
