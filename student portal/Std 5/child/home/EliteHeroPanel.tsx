 ...
 * Premium Layered Identity Panel â€” 3-column hero.
 *
 ...
 *
 * Rich gradient background Â· borderRadius 36 px
 * Structurally filled layout with large KPIs
 * Shadow: 0 25px 70px rgba(99,91,255,0.30) â†’ card looks lifted.
 *
...
/* â”€â”€ Design tokens (light-on-dark palette) â”€â”€â”€â”€â”€â”€â”€â”€ */
...
const T = {
  ...
  success: '#34d399',
  warning: '#fbbf24',
  textSub: 'rgba(240,255,236,0.78)',
  textBody: 'rgba(230,255,226,0.7)',
  greetingBg: 'rgba(236,255,222,0.2)',
  greetingText: '#ffffff',
} as const;

/* â”€â”€ Motivational messages (rotate every 6 s) â”€â”€â”€â”€â”€ */

const MOTIV = [
  'Bird songs cheer you on 🐦',
  'Grow tall like a tree 🌳',
  'Bloom one step at a time 🌸',
  'Tiny atoms, giant ideas ⚛️',
  'Curious minds explore forests 🍃',
  'Fly higher with every lesson 🕊️',
  'You are nature-smart today 🌿',
  'Keep exploring, little ranger 🦊',
];

/* â”€â”€ Level title â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Count-up hook â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Rotating motivation hook â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
/* â”€â”€ Weekly streak bar (7-day demo) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
...
function buildWeekActivity(attendanceDates: string[]): number[] {
  ...
  return Array.from({ length: 7 }, (_, i) => {
    ...
    return set.has(toLocalIso(d)) ? 1 : 0;
  });
}

/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   XP RING â€” Premium 18 px stroke, gradient, glow aura
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   STAT CHIP â€” large rounded chip for visible KPIs
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   FLOATING BLOB â€” slow float (transform only)
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */
...
/* â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
   MICRO DOT â€” tiny particle, opacity pulse
   â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• */

const DOTS = [
  { top: '14%', left: '5%', size: 6, color: '#f6c46b', dur: 5.5, delay: 0 },
  { top: '70%', right: '6%', size: 5, color: '#7fcf88', dur: 6, delay: 1.8 },
  { bottom: '20%', left: '54%', size: 4.5, color: '#f59b7f', dur: 5, delay: 3 },
];
...
export const EliteHeroPanel: React.FC<EliteHeroPanelProps> = React.memo(({
  ...
  const motiv = useRotatingText(MOTIV, 6000);
  const levelTitle = useMemo(() => getLevelTitle(state.level), [state.level]);
  const weekDays = useMemo(() => buildWeekActivity(attendance), [attendance]);
  const activeDays = useMemo(() => weekDays.filter(Boolean).length, [weekDays]);

  /* â”€â”€ 3D micro-tilt (desktop) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  /* â”€â”€ Avatar click bounce â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: '30px 38px',
        minHeight: 300,
        /* â”€â”€ Rich gradient background â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
        background: `
          radial-gradient(circle at 80% 60%, rgba(255,255,255,0.10), transparent 40%),
          radial-gradient(circle at 20% 30%, rgba(255,255,255,0.08), transparent 40%),
          radial-gradient(circle at 55% 100%, rgba(123,89,54,0.22), transparent 52%),
          linear-gradient(135deg, #3f8f3a 0%, #5ba65d 45%, #7ebf5f 100%)
        `,
        boxShadow: '0 25px 70px rgba(53, 110, 52, 0.32), 0 8px 24px rgba(66,96,40,0.20)',
    ...
    >
      ...
      {/* â•â•â• LAYER 2: Animated Radial Glow Blobs â•â•â• */}
      ...
      {/* â•â•â• LAYER 3: Micro Particles â•â•â• */}
      ...
      <div className="relative z-10" style={{
        ...
        {/* â”€â”€ LEFT: Identity (40 %) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  '0 0 0 6px rgba(236,255,222,0.28), 0 10px 25px rgba(63,143,58,0.34)',
                willChange: 'transform',
              }}
              animate={
                avatarBounce
        ...
        <div className="flex flex-col items-center justify-center gap-3 min-w-0">
          ...
          {/* Block 2 â€” Quick stats chips (large KPIs) */}
          <div className="flex items-center gap-2 flex-wrap justify-center">
            <StatChip icon={'\uD83D\uDD25'} val={streak > 0 ? streak : 0} color={T.warning} delay={0.5} />
            <StatChip icon={'\uD83C\uDF96\uFE0F'} val={badges.length} color="#f472b6" delay={0.6} />
            <StatChip icon={'\uD83D\uDCC5'} val={`${activeDays}d`} color={T.success} delay={0.7} />
          </div>

          {/* Block 3 â€” 7-day streak bar */}
          <motion.div
            className="flex items-center gap-1.5"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
        ...
        {/* â”€â”€ RIGHT: XP Ring + Performance (30 %) â”€â”€ */}
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <AnimatePresence>
            {justGained && (
              <motion.span
                style={{ fontSize: 18, fontWeight: 900, color: '#fbbf24' }}
