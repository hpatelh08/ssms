  ...
  >
    ...
    <div className="flex items-center justify-between mb-2 mt-1 shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <div style={{
          padding: '4px 12px', borderRadius: 10,
          background: 'rgba(122,163,68,0.15)',
          border: '1px solid rgba(122,163,68,0.3)',
          color: '#7aa344', fontSize: 12, fontWeight: 700, fontFamily: 'Nunito, sans-serif',
        }}>
    ...
    >
      <span>{'\u{1F30D}'}</span>{' '}
      <span style={{
        background: 'linear-gradient(135deg, #3b82f6, #a7c97f, #fbbf24)',
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{
          color: '#7aa344', fontSize: 14, fontWeight: 700,
