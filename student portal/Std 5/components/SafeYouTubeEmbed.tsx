          ...
          {hasError ? (
            ...
            >
              ...
              <motion.button
                ...
                className="mt-4 px-5 py-2 rounded-xl text-[11px] font-bold text-green-600 cursor-pointer"
                style={{ background: 'rgba(232,246,229,0.8)', border: '1px solid rgba(63,143,58,0.2)' }}
            ...
            <>
              ...
              {isLoading && (
                <motion.div
                  ...
                  exit={{ opacity: 0 }}
                >
                  <div className="w-10 h-10 border-4 border-green-200 border-t-emerald-500 rounded-full animate-spin mb-3" />
