 ...
 * ========================================
 * Addition & subtraction within 20 for Standard 5.
  ...
  return (
    <>
      ...
      <div className="bg-white/75 backdrop-blur-2xl border border-white/40 p-8 sm:p-10 rounded-[24px] text-center max-w-md mx-auto relative overflow-hidden shadow-xl">
        <div className="absolute -top-20 -right-20 w-60 h-60 bg-gradient-to-br from-lime-400 to-green-500 rounded-full opacity-10 blur-3xl pointer-events-none" />
        ...
        <motion.button
          ...
          className="w-full bg-gradient-to-r from-lime-500 to-green-500 text-white font-bold py-4 rounded-2xl shadow-lg shadow-green-500/20 disabled:opacity-50"
