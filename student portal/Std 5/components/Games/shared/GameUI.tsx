  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 bg-gradient-to-br ${
        ...
        : great ? 'from-blue-100/30 via-lime-50/20 to-cyan-100/30'
        ...
        {phase >= 3 && (
          ...
          >
            ...
            {onNextGame && (
              <motion.button
                onClick={onNextGame}
                className="flex-1 bg-gradient-to-r from-lime-500 to-pink-500 text-white font-bold py-3.5 px-5 rounded-2xl shadow-lg shadow-green-500/25 text-sm hover:shadow-xl hover:shadow-green-500/30 transition-shadow"
                whileHover={{ scale: 1.04, y: -2 }}
                whileTap={{ scale: 0.96 }}
              >
                <motion.span
