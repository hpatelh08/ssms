...
const GAME_CARDS = [
  {
    ...
    shadowColor: 'rgba(122,163,68,0.3)',
    hoverGradient: 'from-lime-400 to-green-500',
    iconGlow: 'rgba(122,163,68,0.5)',
  },
  {
    id: 'words',
    icon: '🔤',
  ...
  },
  {
    ...
    shadowColor: 'rgba(63,143,58,0.3)',
    hoverGradient: 'from-green-400 to-emerald-500',
    iconGlow: 'rgba(63,143,58,0.5)',
  },
];
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ background: 'radial-gradient(circle, rgba(122,163,68,0.06) 0%, transparent 70%)' }}
      ...
      <div className="flex items-center gap-3 mb-6 relative z-10">
        <motion.div
          className="w-12 h-12 rounded-2xl bg-gradient-to-br from-lime-400/20 to-pink-400/10 flex items-center justify-center"
          animate={{ rotate: [0, 3, -3, 0] }}
          transition={{ duration: 4, repeat: Infinity, ease: 'easeInOut' }}
        >
          <span className="text-2xl" style={{ filter: 'drop-shadow(0 0 6px rgba(122,163,68,0.4))' }}>🎮</span>
        </motion.div>
        <div>
      ...
      <motion.button
        onClick={onPlayGames}
        className="w-full mt-4 bg-gradient-to-r from-lime-500/10 to-pink-500/10 hover:from-lime-500/20 hover:to-pink-500/20 text-green-700 font-bold py-3 rounded-2xl text-sm transition-colors border border-green-200/20 relative z-10"
