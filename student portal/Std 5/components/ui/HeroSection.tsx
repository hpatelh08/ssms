...
export const HeroSection: React.FC<HeroSectionProps> = React.memo(({
  ...
  const quickActions = useMemo(() => [
    ...
    { icon: '🎮', label: 'Play Game', color: 'from-lime-500 to-pink-500', glow: 'shadow-green-500/20', action: onPlayGames },
      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-5 lg:gap-6 mb-5">
          ...
          <motion.div className="flex-1 min-w-0 text-center lg:text-left"
            ...
            <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
              ...
              <div className="flex items-center gap-1 bg-gradient-to-r from-lime-100/80 to-pink-100/80 px-2.5 py-1 rounded-xl border border-green-200/30">
                <span className="text-sm">🎖️</span>
                <span className="font-bold text-green-600 text-xs">{stats.badges.length} badges</span>
              </div>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mb-4">
          ...
          <motion.div className="bg-white/50 backdrop-blur-sm rounded-xl p-2.5 border border-green-100/30 text-center"
            ...
            <span className="text-lg block">🏅</span>
            <span className="text-base font-black text-green-700">{stats.badges.length}</span>
