...
const FLOWER_COLORS = ['#f472b6', '#fb923c', '#a7c97f', '#facc15', '#f87171', '#38bdf8', '#e879f9', '#34d399'];
const FRUIT_COLORS = ['#ef4444', '#f59e0b', '#ec4899', '#5f8b3d', '#f97316', '#06b6d4'];
...
const Butterflies: React.FC = React.memo(() => (
  <g>
    {[
      ...
      { x: 200, y: 130, delay: '1.5s', color: '#a7c97f' },
