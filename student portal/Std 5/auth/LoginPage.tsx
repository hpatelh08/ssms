...
const modalCopy = {
  badge: 'Discovery Family Pass',
  title: 'Enter Discovery Parent Key',
  description: 'Confirm family access to open the Std 5 discovery dashboard for',
  label: 'Discovery Parent Key',
  placeholder: 'Enter discovery key',
  helper: 'Use this family key to switch from the student discovery zone to the parent view.',
  submit: 'Open Parent Discovery View',
};
